...
{
    public class GetTCTWLEventListRD : IAPIResponseData
    {

        public List<T_CTW_LEventInfo> T_CTW_LEventList { get; set; }
        
            public int TotalCount { get; set; }
         public int TotalPage { get; set; }
    }

    public class T_CTW_LEventInfo{
        
        public string EventBeginTime { get; set; }
             public string EventEndTime { get; set; }
             public string PrizeGet { get; set; }
             public string EventSales { get; set; }
             public string NewVip { get; set; }
             public string NewAtten { get; set; }
             public string LeventId { get; set; }//----游戏或促销活动Id
