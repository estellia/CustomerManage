Jit.AM.defindPage({
	...
	initPageInfo:function(){
		...
		$('[jitval=itemPrice]').html(data.integralExchange);
	...
	submitOrder:function(){
		...
		if(!me.getParams('IsRegister')){
			...
			var source = 'source=/HtmlApps/Auth.html?pageName=GoodsJiFenDetail&goodsId='+me.getUrlParam('goodsId')+'&userId='+me.getBaseInfo().userId+'&openId='+me.getBaseInfo().openId+'&customerId='+me.getBaseInfo().customerId+'&locale='+me.getBaseInfo().locale;
