Jit.AM.defindPage({
    ...
    initLoad: function() {
		...
		var activityId = self.getUrlParam('activityId');
		var $chTitle = $('#chTitle');
		
		if(activityId == "2d517a7bf7253c906046a1ad089f7e5e"){
			$chTitle.find("p").eq(0).show();
		} else if(activityId == "b7b86c479021d59a4304643d93735c99"){
			$chTitle.find("p").eq(1).show();
		}else if(activityId == "3255d3e9454e8d6ef1f75db7bd22f535"){
			$chTitle.find("p").eq(2).show();
		}else if(activityId == "28e09d13a4a72e659bf6c0fa730e1870"){
			$chTitle.find("p").eq(3).show();
		}else if(activityId == "c619ca810fc5cd4ad39ce143643c70cd"){
			$chTitle.find("p").eq(4).show();
		}
        ...
        self.ajax({
            ...
            data: {
                ...
                'ActivityID': self.getUrlParam('activityId')
            },
            beforeSend: function() {
                UIBase.loading.show();
            },
        ...
        self.ajax({
            ...
            data: {
                ...
                TypeID: '2',
                'EventID': self.getUrlParam('activityId')
            },
            success: function(data) {
        ...
        self.ajax({
            ...
            success: function(data) {
                ...
                if (data && data.code == 200) {
                    ...
                    self.elements.actBoxSubmit.html(self.language == "1" ? '您已报名' : 'complete');
