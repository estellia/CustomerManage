...
Jit.AM.defindPage({
    ...
    initEvent: function() {
		...
		*/
		$('#categoryMainList').delegate('.commonSubList li','click',function(){
			var $this = $(this),
				goodsType = $this.data('goodstype');
			Jit.AM.setPageParam('Jit_defaultGoodsType',goodsType);
			Jit.AM.toPageWithParam('GoodsList','goodsType='+goodsType);
		});
    ...
    loadCategoryList: function() {
        ...
        self.ajax({
            ...
            complete:function(){
				...
				if(!!Jit.AM.getPageParam("Jit_defaultGoodsType")){
					$('.commonSubList li[data-goodstype='+Jit.AM.getPageParam("Jit_defaultGoodsType")+']').addClass('on');
				}
