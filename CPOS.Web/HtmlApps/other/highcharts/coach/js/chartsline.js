	    ...
	    loadData:function(callback){
	    	...
	    	$.util.ajax({
	    		...
	    		data:{
	    			...
	    			PGToken:that.token,
	    			ReportAction: "ireport!teacherStatMonthlyReport.action",
	    			DynamicParam:"email="+that.email
	    		},
		...
		generateCharts:function(object){
			...
			$('#container').highcharts({
	            ...
	            },
	            {
	                ...
	                name: 'selling skills',
	                data: [4.1, 3.8, 3.6, 4.2, 2.1,3.1]
	            },
	            {
	                name: 'Recognition',
	                data: [2.1, 2.2, 2.3, 2.4, 2.5,4.5]
	            },{
	                name: 'Will',
	                data: [4.1, 3.8, 3.6, 4.2, 2.1,3.1]
	            },
