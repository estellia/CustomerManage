	...
	var UI = {
		...
		Dialog:function(cfg){
			...
			if(cfg == 'CLOSE'){
				...
				var btnstr = (cfg.type == 'Alert')?'<a id="jit_btn_ok" style="margin:0 auto">'+cfg.LabelOk+'</a>':'<a id="jit_btn_cancel">'+cfg.LabelCancel+'</a><a id="jit_btn_ok">'+cfg.LabelOk+'</a>';
				
				var panel = $('<div"><div class="jit-ui-panel"></div><div style="margin-top:60px" class="popup br-5">'
