...
var Base = {
    ...
    userId: function () {
        ...
        return G("userId"); //-------------------------------
        // return userId;
        //return '169c3578868240d0aa6c9d7bf256d981';
    },
    customerId: function () {
        var customerId = getParam("customerId");
        return customerId;
        //return 'f6a7da3d28f74f2abedfc3ea0cf65c01';
    },
    locale: function () {
        return 'zh';
    },
...
function Init() {
    if ($("#MenuBox").length > 0) {
        ...
        var IMenu = '<ul><li><a onclick="backReload(this)" href="javascript:void(0)"';
        if (getRel == "1") {
            IMenu += " class='ImenuClass' "
        }
        IMenu += ' id="btn-back"><div class="smain1"><img src="images/nt1.png"></div>返回</a></li> <li><a href="index.html"><div class="smain1"><img src="images/nt2.png"></div> 首页</a></li><li><a href="share.html"';
        if (getRel == "3") {
            IMenu += " class='ImenuClass' "
        }
...
function backReload(obj) {
    if (obj.getAttribute("id") == "btn-back") {
        if (getParam("back") != "") {
