    ...
    public partial class Data : System.Web.UI.Page
    {
        ...
        public string getDeliveryList()
        {
            ...
            try
            {
                ...
                foreach (var paymentInfo in deliveryList)
                {
                    ...
                    else if (paymentInfo.DeliveryId == "2"|| paymentInfo.DeliveryId == "4")//判断到店自提是否启用
                    {
                        //到店提货信息
                        CustomerTakeDeliveryBLL takeDeliveryBLL = new CustomerTakeDeliveryBLL(loggingSessionInfo);
        ...
        public string getSkuProp2List()
        {
            ...
            try
            {
                ...
                var dsProp2 = itemService.GetItemProp2List(reqObj.special.itemId, reqObj.special.propDetailId, reqObj.special.prop1DetailId, type,eventId);
