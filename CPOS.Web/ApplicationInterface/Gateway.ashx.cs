    ...
    public class Gateway : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                #region 插入日志信息  Add by emeisoft

                Loggers.Debug(new DebugLogInfo() { Message = "新干线软件：ApplicationInterface/Gateway.ashx?action=" + action + "&type=" + strAPIType + "&req=" + reqContent });
