...
as CollectIncome");
            ...
            //因为做订单的同事说sales_unit_id和purchase_unit_id已经做了统一化，所以只需要一个条件就可以了  or a.purchase_unit_id=b.unit_id
        ...
        public DataSet GetServiceOrderList(string order_no, string OrderChannelID, string userId, string customerId, int? pageSize, int? pageIndex)
        {
            ...
            sqlWhere += "  and sales_user=@pUserId and customer_id=@pCustomerId AND a.Field1='1'";//当前登录帐户销售的 {已完成的订单。}
