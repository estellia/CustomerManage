...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class TInOutStatusNodeDAO : Base.BaseCPOSDAO, ICRUDable<TInOutStatusNodeEntity>, IQueryable<TInOutStatusNodeEntity>
    {
        ...
        public DataSet GetPrintPickingInfo(string orderID)
        {
            ...
            ,(CASE WHEN ti.Field8 = 1 THEN ti.Field3 WHEN ti.Field8 = 2 THEN ti.Field14 WHEN ti.Field8 = 4 THEN ti.Field14 END) as username
            ,ti.Field6 as tel
            ,(CASE WHEN ti.Field8 = 1 THEN ti.field9 WHEN ti.Field8 = 2 THEN ti.reserveDay  + N' ' + ti.reserveQuantum WHEN ti.Field8 = 4 THEN ti.reserveDay  + N' ' + ti.reserveQuantum END) as time
