...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class WMaterialVoiceDAO : Base.BaseCPOSDAO, ICRUDable<WMaterialVoiceEntity>, IQueryable<WMaterialVoiceEntity>
    {
        ...
        /// 获取列表
        /// </summary>
        public DataSet GetWebList(WMaterialVoiceEntity entity, int Page, int PageSize)
        {
        ...
        private string GetWebListSql(WMaterialVoiceEntity entity)
        {
            ...
            sql += " into #tmp ";
            sql += " from [WMaterialVoice] a ";
            sql += " left join [t_user] b on a.createBy=b.User_Id ";
            sql += " inner join [WModelVoiceMapping] c on (c.isDelete='0' and a.VoiceId=c.VoiceId) ";
