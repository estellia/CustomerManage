...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class WApplicationInterfaceDAO : Base.BaseCPOSDAO, ICRUDable<WApplicationInterfaceEntity>, IQueryable<WApplicationInterfaceEntity>
    {
        ...
        public void Create(WApplicationInterfaceEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("[WeiXinName],[WeiXinID],[URL],[Token],[AppID],[AppSecret],[ServerIP],[FileAddress],[IsHeight],[CreateTime],[CreateBy],[LastUpdateBy],[IsDelete],[LoginUser],[LoginPass],[CustomerId],[WeiXinTypeId],[AuthUrl],[RequestToken],[ExpirationTime],[IsMoreCS],[PrevEncodingAESKey],[CurrentEncodingAESKey],[EncryptType],[IsPayments],[LastUpdateTime],[OpenOAuthAppid],[ApplicationId])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@IsPayments",SqlDbType.Int),
					new SqlParameter("@LastUpdateTime",SqlDbType.DateTime),
					new SqlParameter("@OpenOAuthAppid",SqlDbType.VarChar),
			...
			parameters[13].Value = pEntity.LoginUser;
			parameters[14].Value = pEntity.LoginPass;
			parameters[15].Value = pEntity.CustomerId;
			parameters[16].Value = pEntity.WeiXinTypeId;
			parameters[17].Value = pEntity.AuthUrl;
			parameters[18].Value = pEntity.RequestToken;
			parameters[19].Value = pEntity.ExpirationTime;
			parameters[20].Value = pEntity.IsMoreCS;
			parameters[21].Value = pEntity.PrevEncodingAESKey;
			parameters[22].Value = pEntity.CurrentEncodingAESKey;
			parameters[23].Value = pEntity.EncryptType;
			parameters[24].Value = pEntity.IsPayments;
			parameters[25].Value = pEntity.LastUpdateTime;
			parameters[26].Value = pEntity.OpenOAuthAppid;
        ...
        public WApplicationInterfaceEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [WApplicationInterface] where 1=1  and isdelete=0");
            //读取数据
        ...
        public void Update(WApplicationInterfaceEntity pEntity, bool pIsUpdateNullField, IDbTransaction pTran)
        {
            ...
            if (pIsUpdateNullField || pEntity.IsPayments!=null)
                strSql.Append( "[IsPayments]=@IsPayments,");
            if (pIsUpdateNullField || pEntity.LastUpdateTime!=null)
                strSql.Append( "[LastUpdateTime]=@LastUpdateTime,");
            if (pIsUpdateNullField || pEntity.OpenOAuthAppid!=null)
                strSql.Append( "[OpenOAuthAppid]=@OpenOAuthAppid");
			...
			parameters[10].Value = pEntity.LoginUser;
			parameters[11].Value = pEntity.LoginPass;
			parameters[12].Value = pEntity.CustomerId;
			parameters[13].Value = pEntity.WeiXinTypeId;
			parameters[14].Value = pEntity.AuthUrl;
			parameters[15].Value = pEntity.RequestToken;
			parameters[16].Value = pEntity.ExpirationTime;
			parameters[17].Value = pEntity.IsMoreCS;
			parameters[18].Value = pEntity.PrevEncodingAESKey;
			parameters[19].Value = pEntity.CurrentEncodingAESKey;
			parameters[20].Value = pEntity.EncryptType;
			parameters[21].Value = pEntity.IsPayments;
			parameters[22].Value = pEntity.LastUpdateTime;
			parameters[23].Value = pEntity.OpenOAuthAppid;
			parameters[24].Value = pEntity.ApplicationId;
        ...
        public void Delete(WApplicationInterfaceEntity[] pEntities, IDbTransaction pTran)
        {
            ...
            for (int i = 0; i < pEntities.Length; i++)
            {
                ...
                entityIDs[i] = pEntity.ApplicationId;
            }
        ...
        public PagedQueryResult<WApplicationInterfaceEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            ...
            pagedSql.AppendFormat(") as ___rn,* from [WApplicationInterface] where 1=1  and isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [WApplicationInterface] where 1=1  and isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
        ...
        { 
            ...
            if (pQueryEntity.IsPayments!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "IsPayments", Value = pQueryEntity.IsPayments });
            if (pQueryEntity.LastUpdateTime!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "LastUpdateTime", Value = pQueryEntity.LastUpdateTime });
            if (pQueryEntity.OpenOAuthAppid!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "OpenOAuthAppid", Value = pQueryEntity.OpenOAuthAppid });
        ...
        protected void Load(IDataReader pReader, out WApplicationInterfaceEntity pInstance)
        {
			...
			if (pReader["IsPayments"] != DBNull.Value)
			{
				pInstance.IsPayments =   Convert.ToInt32(pReader["IsPayments"]);
			}
			if (pReader["LastUpdateTime"] != DBNull.Value)
			{
				pInstance.LastUpdateTime =  Convert.ToDateTime(pReader["LastUpdateTime"]);
			}
			if (pReader["OpenOAuthAppid"] != DBNull.Value)
			{
				pInstance.OpenOAuthAppid =  Convert.ToString(pReader["OpenOAuthAppid"]);
			}
