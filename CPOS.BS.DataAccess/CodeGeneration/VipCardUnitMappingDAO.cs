...
namespace JIT.CPOS.BS.DataAccess
{
    /// <summary>
    /// 数据访问：  
    /// 表VipCardUnitMapping的数据访问类     
    /// 1.实现ICRUDable接口
    /// 2.实现IQueryable接口
    /// 3.实现Load方法
    /// </summary>
    public partial class VipCardUnitMappingDAO : Base.BaseCPOSDAO, ICRUDable<VipCardUnitMappingEntity>, IQueryable<VipCardUnitMappingEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardUnitMappingDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(VipCardUnitMappingEntity pEntity)
        {
        ...
        public void Create(VipCardUnitMappingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
        ...
        public VipCardUnitMappingEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
        ...
        /// </summary>
        /// <returns></returns>
        public VipCardUnitMappingEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(VipCardUnitMappingEntity pEntity , IDbTransaction pTran)
        {
            Update(pEntity,true,pTran);
        }
        public void Update(VipCardUnitMappingEntity pEntity , bool pIsUpdateNullField, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(VipCardUnitMappingEntity pEntity )
        {
            Update(pEntity ,true);
        }
        public void Update(VipCardUnitMappingEntity pEntity ,bool pIsUpdateNullField )
        {
        ...
        public void Delete(VipCardUnitMappingEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(VipCardUnitMappingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(VipCardUnitMappingEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(VipCardUnitMappingEntity[] pEntities)
        { 
        ...
        /// <returns></returns>
        public VipCardUnitMappingEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [VipCardUnitMapping] where 1=1  and isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<VipCardUnitMappingEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            //执行语句并返回结果
            PagedQueryResult<VipCardUnitMappingEntity> result = new PagedQueryResult<VipCardUnitMappingEntity>();
            List<VipCardUnitMappingEntity> list = new List<VipCardUnitMappingEntity>();
        ...
        public VipCardUnitMappingEntity[] QueryByEntity(VipCardUnitMappingEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<VipCardUnitMappingEntity> PagedQueryByEntity(VipCardUnitMappingEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(VipCardUnitMappingEntity pQueryEntity)
        { 
            //获取非空属性数量
