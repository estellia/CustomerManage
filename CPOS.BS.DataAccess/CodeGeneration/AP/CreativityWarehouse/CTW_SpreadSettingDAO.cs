...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class CTW_SpreadSettingDAO : Base.BaseCPOSDAO, ICRUDable<CTW_SpreadSettingEntity>, IQueryable<CTW_SpreadSettingEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public CTW_SpreadSettingDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(CTW_SpreadSettingEntity pEntity)
        {
        ...
        public void Create(CTW_SpreadSettingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("[SpreadType],[Title],[ImageId],[Summary],[PromptText],[LeadPageSharePromptText],[LeadPageFocusPromptText],[LeadPageRegPromptText],[TemplateId],[CreateTime],[CreateBy],[LastUpdateTime],[LastUpdateBy],[IsDelete],[Id])");
			...
			parameters[5].Value = pEntity.LeadPageSharePromptText;
			parameters[6].Value = pEntity.LeadPageFocusPromptText;
			parameters[7].Value = pEntity.LeadPageRegPromptText;
        ...
        public CTW_SpreadSettingEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            //读取数据
            CTW_SpreadSettingEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public CTW_SpreadSettingEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [T_CTW_SpreadSetting] where 1=1  and isdelete=0");
            //读取数据
            List<CTW_SpreadSettingEntity> list = new List<CTW_SpreadSettingEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
                    CTW_SpreadSettingEntity m;
                    this.Load(rdr, out m);
                    list.Add(m);
                }
            }
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(CTW_SpreadSettingEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(CTW_SpreadSettingEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(CTW_SpreadSettingEntity pEntity )
        {
        ...
        public void Delete(CTW_SpreadSettingEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(CTW_SpreadSettingEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(CTW_SpreadSettingEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(CTW_SpreadSettingEntity[] pEntities)
        { 
        ...
        /// <returns></returns>
        public CTW_SpreadSettingEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [T_CTW_SpreadSetting] where 1=1  and isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<CTW_SpreadSettingEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            //执行语句并返回结果
            PagedQueryResult<CTW_SpreadSettingEntity> result = new PagedQueryResult<CTW_SpreadSettingEntity>();
            List<CTW_SpreadSettingEntity> list = new List<CTW_SpreadSettingEntity>();
        ...
        public CTW_SpreadSettingEntity[] QueryByEntity(CTW_SpreadSettingEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<CTW_SpreadSettingEntity> PagedQueryByEntity(CTW_SpreadSettingEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(CTW_SpreadSettingEntity pQueryEntity)
        { 
            //获取非空属性数量
        ...
        protected void Load(IDataReader pReader, out CTW_SpreadSettingEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new CTW_SpreadSettingEntity();
