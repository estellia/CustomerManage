...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    /// 3.实现Load方法
    /// </summary>
    public partial class RechargeOrderDAO : BaseCPOSDAO, ICRUDable<RechargeOrderEntity>, IQueryable<RechargeOrderEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        ...
        public void Create(RechargeOrderEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("[OrderNo],[OrderDesc],[VipID],[VipCardNo],[UnitCode],[TotalAmount],[ActuallyPaid],[ReturnAmount],[PayPoints],[ReceivePoints],[PayerID],[PayID],[Status],[CustomerID],[CreateTime],[CreateBy],[LastUpdateTime],[LastUpdateBy],[IsDelete],[UnitId],[UserId],[AmountFromPayPoints],[PayDateTime],[VipCardTypeId],[PosSourceName],[OrderID])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@PosSourceName",SqlDbType.NVarChar),
			...
			parameters[19].Value = pEntity.UnitId;
			parameters[20].Value = pEntity.UserId;
			parameters[21].Value = pEntity.AmountFromPayPoints;
			parameters[22].Value = pEntity.PayDateTime;
			parameters[23].Value = pEntity.VipCardTypeId;
			parameters[24].Value = pEntity.PosSourceName;
        ...
        public void Update(RechargeOrderEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            ...
            if (pIsUpdateNullField || pEntity.PosSourceName!=null)
                strSql.Append( "[PosSourceName]=@PosSourceName");
			...
			parameters[16].Value = pEntity.UnitId;
			parameters[17].Value = pEntity.UserId;
			parameters[18].Value = pEntity.AmountFromPayPoints;
			parameters[19].Value = pEntity.PayDateTime;
			parameters[20].Value = pEntity.VipCardTypeId;
			parameters[21].Value = pEntity.PosSourceName;
			parameters[22].Value = pEntity.OrderID;
        ...
        { 
            ...
            if (pQueryEntity.PosSourceName!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "PosSourceName", Value = pQueryEntity.PosSourceName });
        ...
        protected void Load(IDataReader pReader, out RechargeOrderEntity pInstance)
        {
			...
			if (pReader["PosSourceName"] != DBNull.Value)
			{
				pInstance.PosSourceName =  Convert.ToString(pReader["PosSourceName"]);
			}
