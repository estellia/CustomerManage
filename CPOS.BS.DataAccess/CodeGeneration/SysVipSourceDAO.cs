...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    /// 3.实现Load方法
    /// </summary>
    public partial class SysVipSourceDAO : Base.BaseCPOSDAO, ICRUDable<SysVipSourceEntity>, IQueryable<SysVipSourceEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SysVipSourceDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(SysVipSourceEntity pEntity)
        {
        ...
        public void Create(SysVipSourceEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
        ...
        public SysVipSourceEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
        ...
        /// </summary>
        /// <returns></returns>
        public SysVipSourceEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
        ...
        public void Delete(SysVipSourceEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(SysVipSourceEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //执行 
            this.Delete(pEntity.VipSourceID, pTran);           
        }
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(SysVipSourceEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(SysVipSourceEntity[] pEntities)
        { 
        ...
        /// <returns></returns>
        public SysVipSourceEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [SysVipSource] where 1=1  and isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<SysVipSourceEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            //执行语句并返回结果
            PagedQueryResult<SysVipSourceEntity> result = new PagedQueryResult<SysVipSourceEntity>();
            List<SysVipSourceEntity> list = new List<SysVipSourceEntity>();
        ...
        public SysVipSourceEntity[] QueryByEntity(SysVipSourceEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<SysVipSourceEntity> PagedQueryByEntity(SysVipSourceEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(SysVipSourceEntity pQueryEntity)
        { 
            //获取非空属性数量
        ...
        protected void Load(IDataReader pReader, out SysVipSourceEntity pInstance)
        {
			...
			{
				pInstance.VipSourceName =  Convert.ToString(pReader["VipSourceName"]);
			}
