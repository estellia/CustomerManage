...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class T_InoutDAO : Base.BaseCPOSDAO, ICRUDable<T_InoutEntity>, IQueryable<T_InoutEntity>
    {
        ...
        public void Create(T_InoutEntity pEntity, IDbTransaction pTran)
        {
			...
			parameters[2].Value = pEntity.order_type_id;
			parameters[3].Value = pEntity.order_reason_id;
			parameters[4].Value = pEntity.red_flag;
			parameters[5].Value = pEntity.ref_order_id;
			parameters[6].Value = pEntity.ref_order_no;
			parameters[7].Value = pEntity.warehouse_id;
			parameters[8].Value = pEntity.order_date;
			parameters[9].Value = pEntity.request_date;
			parameters[10].Value = pEntity.complete_date;
			parameters[11].Value = pEntity.create_unit_id;
			parameters[12].Value = pEntity.unit_id;
			parameters[13].Value = pEntity.related_unit_id;
			parameters[14].Value = pEntity.related_unit_code;
			parameters[15].Value = pEntity.pos_id;
			parameters[16].Value = pEntity.shift_id;
			parameters[17].Value = pEntity.sales_user;
			parameters[18].Value = pEntity.total_amount;
			parameters[19].Value = pEntity.discount_rate;
			parameters[20].Value = pEntity.actual_amount;
			parameters[21].Value = pEntity.receive_points;
			parameters[22].Value = pEntity.pay_points;
			parameters[23].Value = pEntity.pay_id;
			parameters[24].Value = pEntity.print_times;
			parameters[25].Value = pEntity.carrier_id;
			parameters[26].Value = pEntity.remark;
			parameters[27].Value = pEntity.status;
			parameters[28].Value = pEntity.status_desc;
			parameters[29].Value = pEntity.total_qty;
			parameters[30].Value = pEntity.total_retail;
			parameters[31].Value = pEntity.keep_the_change;
			parameters[32].Value = pEntity.wiping_zero;
			parameters[33].Value = pEntity.vip_no;
			parameters[34].Value = pEntity.create_time;
			parameters[35].Value = pEntity.create_user_id;
			parameters[36].Value = pEntity.approve_time;
			parameters[37].Value = pEntity.approve_user_id;
			parameters[38].Value = pEntity.send_time;
			parameters[39].Value = pEntity.send_user_id;
			parameters[40].Value = pEntity.accpect_time;
			parameters[41].Value = pEntity.accpect_user_id;
			parameters[42].Value = pEntity.modify_time;
			parameters[43].Value = pEntity.modify_user_id;
			parameters[44].Value = pEntity.data_from_id;
			parameters[45].Value = pEntity.sales_unit_id;
			parameters[46].Value = pEntity.purchase_unit_id;
			parameters[47].Value = pEntity.if_flag;
			parameters[48].Value = pEntity.customer_id;
			parameters[49].Value = pEntity.bat_id;
			parameters[50].Value = pEntity.sales_warehouse_id;
			parameters[51].Value = pEntity.purchase_warehouse_id;
			parameters[52].Value = pEntity.Field1;
			parameters[53].Value = pEntity.Field2;
			parameters[54].Value = pEntity.Field3;
			parameters[55].Value = pEntity.Field4;
			parameters[56].Value = pEntity.Field5;
			parameters[57].Value = pEntity.Field6;
			parameters[58].Value = pEntity.Field7;
			parameters[59].Value = pEntity.Field8;
			parameters[60].Value = pEntity.Field9;
			parameters[61].Value = pEntity.Field10;
			parameters[62].Value = pEntity.Field11;
			parameters[63].Value = pEntity.Field12;
			parameters[64].Value = pEntity.Field13;
			parameters[65].Value = pEntity.Field14;
			parameters[66].Value = pEntity.Field15;
			parameters[67].Value = pEntity.Field16;
			parameters[68].Value = pEntity.Field17;
			parameters[69].Value = pEntity.Field18;
			parameters[70].Value = pEntity.Field19;
			parameters[71].Value = pEntity.Field20;
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [T_Inout] set status='-1' where order_id=@order_id;");
        ...
        { 
            ...
            if (pQueryEntity.ReturnCash!=null)
        ...
        protected void Load(IDataReader pReader, out T_InoutEntity pInstance)
        {
			...
			if (pReader["pay_id"] != DBNull.Value)
			{
                ...
                var paymentTypeBLL = new T_Payment_TypeDAO(CurrentUserInfo);
                var paymentTypeInfo = paymentTypeBLL.GetByID(pInstance.pay_id);
                if (paymentTypeInfo != null)
                {
                    pInstance.Payment_Type_Code = paymentTypeInfo.Payment_Type_Code;
                    pInstance.Payment_Type_Name = paymentTypeInfo.Payment_Type_Name;
                }
