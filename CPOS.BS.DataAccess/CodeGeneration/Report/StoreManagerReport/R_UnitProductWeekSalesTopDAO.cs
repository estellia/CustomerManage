...
namespace JIT.CPOS.BS.DataAccess
{
    /// <summary>
    /// 数据访问：  
    /// 表R_UnitProductWeekSalesTop的数据访问类     
    /// 1.实现ICRUDable接口
    /// 2.实现IQueryable接口
    /// 3.实现Load方法
    /// </summary>
    public partial class R_UnitProductWeekSalesTopDAO : Base.BaseCPOSDAO, ICRUDable<R_UnitProductWeekSalesTopEntity>, IQueryable<R_UnitProductWeekSalesTopEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_UnitProductWeekSalesTopDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(R_UnitProductWeekSalesTopEntity pEntity)
        {
        ...
        public void Create(R_UnitProductWeekSalesTopEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("insert into [R_UnitProductWeekSalesTop](");
        ...
        public R_UnitProductWeekSalesTopEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [R_UnitProductWeekSalesTop] where ID='{0}'  ", id.ToString());
            //读取数据
            R_UnitProductWeekSalesTopEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public R_UnitProductWeekSalesTopEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [R_UnitProductWeekSalesTop] where 1=1 ");
            //读取数据
            List<R_UnitProductWeekSalesTopEntity> list = new List<R_UnitProductWeekSalesTopEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
                    R_UnitProductWeekSalesTopEntity m;
                    this.Load(rdr, out m);
                    list.Add(m);
                }
            }
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(R_UnitProductWeekSalesTopEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(R_UnitProductWeekSalesTopEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [R_UnitProductWeekSalesTop] set ");
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(R_UnitProductWeekSalesTopEntity pEntity )
        {
        ...
        public void Delete(R_UnitProductWeekSalesTopEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(R_UnitProductWeekSalesTopEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [R_UnitProductWeekSalesTop] set  where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(R_UnitProductWeekSalesTopEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(R_UnitProductWeekSalesTopEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [R_UnitProductWeekSalesTop] set  where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public R_UnitProductWeekSalesTopEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [R_UnitProductWeekSalesTop] where 1=1  ");
        ...
        /// <returns></returns>
        public PagedQueryResult<R_UnitProductWeekSalesTopEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [R_UnitProductWeekSalesTop] where 1=1  ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [R_UnitProductWeekSalesTop] where 1=1  ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<R_UnitProductWeekSalesTopEntity> result = new PagedQueryResult<R_UnitProductWeekSalesTopEntity>();
            List<R_UnitProductWeekSalesTopEntity> list = new List<R_UnitProductWeekSalesTopEntity>();
        ...
        public R_UnitProductWeekSalesTopEntity[] QueryByEntity(R_UnitProductWeekSalesTopEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<R_UnitProductWeekSalesTopEntity> PagedQueryByEntity(R_UnitProductWeekSalesTopEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(R_UnitProductWeekSalesTopEntity pQueryEntity)
        { 
            //获取非空属性数量
        ...
        protected void Load(IDataReader pReader, out R_UnitProductWeekSalesTopEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new R_UnitProductWeekSalesTopEntity();
