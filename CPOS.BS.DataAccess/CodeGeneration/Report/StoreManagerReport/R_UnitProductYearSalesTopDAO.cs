...
namespace JIT.CPOS.BS.DataAccess
{
    /// <summary>
    /// 数据访问：  
    /// 表R_UnitProductYearSalesTop的数据访问类     
    /// 1.实现ICRUDable接口
    /// 2.实现IQueryable接口
    /// 3.实现Load方法
    /// </summary>
    public partial class R_UnitProductYearSalesTopDAO : Base.BaseCPOSDAO, ICRUDable<R_UnitProductYearSalesTopEntity>, IQueryable<R_UnitProductYearSalesTopEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_UnitProductYearSalesTopDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(R_UnitProductYearSalesTopEntity pEntity)
        {
        ...
        public void Create(R_UnitProductYearSalesTopEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
            ...
            strSql.Append("insert into [R_UnitProductYearSalesTop](");
        ...
        public R_UnitProductYearSalesTopEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [R_UnitProductYearSalesTop] where ID='{0}'  ", id.ToString());
            //读取数据
            R_UnitProductYearSalesTopEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public R_UnitProductYearSalesTopEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [R_UnitProductYearSalesTop] where 1=1 ");
            //读取数据
            List<R_UnitProductYearSalesTopEntity> list = new List<R_UnitProductYearSalesTopEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
                    R_UnitProductYearSalesTopEntity m;
                    this.Load(rdr, out m);
                    list.Add(m);
                }
            }
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(R_UnitProductYearSalesTopEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(R_UnitProductYearSalesTopEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [R_UnitProductYearSalesTop] set ");
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(R_UnitProductYearSalesTopEntity pEntity )
        {
        ...
        public void Delete(R_UnitProductYearSalesTopEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(R_UnitProductYearSalesTopEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [R_UnitProductYearSalesTop] set  where ID=@ID;");
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(R_UnitProductYearSalesTopEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(R_UnitProductYearSalesTopEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [R_UnitProductYearSalesTop] set  where ID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public R_UnitProductYearSalesTopEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [R_UnitProductYearSalesTop] where 1=1  ");
        ...
        /// <returns></returns>
        public PagedQueryResult<R_UnitProductYearSalesTopEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            pagedSql.AppendFormat(") as ___rn,* from [R_UnitProductYearSalesTop] where 1=1  ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [R_UnitProductYearSalesTop] where 1=1  ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<R_UnitProductYearSalesTopEntity> result = new PagedQueryResult<R_UnitProductYearSalesTopEntity>();
            List<R_UnitProductYearSalesTopEntity> list = new List<R_UnitProductYearSalesTopEntity>();
        ...
        public R_UnitProductYearSalesTopEntity[] QueryByEntity(R_UnitProductYearSalesTopEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<R_UnitProductYearSalesTopEntity> PagedQueryByEntity(R_UnitProductYearSalesTopEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(R_UnitProductYearSalesTopEntity pQueryEntity)
        { 
            //获取非空属性数量
        ...
        protected void Load(IDataReader pReader, out R_UnitProductYearSalesTopEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new R_UnitProductYearSalesTopEntity();
