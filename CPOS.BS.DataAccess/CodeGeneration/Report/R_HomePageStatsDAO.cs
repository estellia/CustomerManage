    ...
    public partial class R_HomePageStatsDAO : Base.BaseCPOSDAO, ICRUDable<R_HomePageStatsEntity>, IQueryable<R_HomePageStatsEntity>
    {
        ...
        public void Create(R_HomePageStatsEntity pEntity, IDbTransaction pTran)
        {
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@SuperRetailTraderCount",SqlDbType.Int),
					new SqlParameter("@CurrentDaySuperRetailTraderOrderAmount",SqlDbType.Decimal),
					new SqlParameter("@LastDaySuperRetailTraderOrderAmount",SqlDbType.Decimal),
					new SqlParameter("@CurrentDaySuperRetailTraderOrderAmountDToD",SqlDbType.Decimal),
            ...
            parameters[43].Value = pEntity.SuperRetailTraderCount;
            parameters[44].Value = pEntity.CurrentDaySuperRetailTraderOrderAmount;
            parameters[45].Value = pEntity.LastDaySuperRetailTraderOrderAmount;
            parameters[46].Value = pEntity.CurrentDaySuperRetailTraderOrderAmountDToD;
            parameters[47].Value = pkGuid;
        ...
        public void Update(R_HomePageStatsEntity pEntity, IDbTransaction pTran, bool pIsUpdateNullField)
        {
            ...
            if (pIsUpdateNullField || pEntity.SuperRetailTraderCount != null)
                strSql.Append("[SuperRetailTraderCount]=@SuperRetailTraderCount,");
            if (pIsUpdateNullField || pEntity.CurrentDaySuperRetailTraderOrderAmount != null)
                strSql.Append("[CurrentDaySuperRetailTraderOrderAmount]=@CurrentDaySuperRetailTraderOrderAmount,");
            if (pIsUpdateNullField || pEntity.LastDaySuperRetailTraderOrderAmount != null)
                strSql.Append("[LastDaySuperRetailTraderOrderAmount]=@LastDaySuperRetailTraderOrderAmount,");
            if (pIsUpdateNullField || pEntity.CurrentDaySuperRetailTraderOrderAmountDToD != null)
                strSql.Append("[CurrentDaySuperRetailTraderOrderAmountDToD]=@CurrentDaySuperRetailTraderOrderAmountDToD");
            ...
            parameters[42].Value = pEntity.SuperRetailTraderCount;
            parameters[43].Value = pEntity.CurrentDaySuperRetailTraderOrderAmount;
            parameters[44].Value = pEntity.LastDaySuperRetailTraderOrderAmount;
            parameters[45].Value = pEntity.CurrentDaySuperRetailTraderOrderAmountDToD;
            parameters[46].Value = pEntity.ID;
        ...
        protected IWhereCondition[] GetWhereConditionByEntity(R_HomePageStatsEntity pQueryEntity)
        {
            ...
            if (pQueryEntity.SuperRetailTraderCount != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "SuperRetailTraderCount", Value = pQueryEntity.SuperRetailTraderCount });
            if (pQueryEntity.CurrentDaySuperRetailTraderOrderAmount != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "CurrentDaySuperRetailTraderOrderAmount", Value = pQueryEntity.CurrentDaySuperRetailTraderOrderAmount });
            if (pQueryEntity.LastDaySuperRetailTraderOrderAmount != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "LastDaySuperRetailTraderOrderAmount", Value = pQueryEntity.LastDaySuperRetailTraderOrderAmount });
            if (pQueryEntity.CurrentDaySuperRetailTraderOrderAmountDToD != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "CurrentDaySuperRetailTraderOrderAmountDToD", Value = pQueryEntity.CurrentDaySuperRetailTraderOrderAmountDToD });
        ...
        protected void Load(IDataReader pReader, out R_HomePageStatsEntity pInstance)
        {
            ...
            if (pReader["SuperRetailTraderCount"] != DBNull.Value)
            {
                pInstance.SuperRetailTraderCount = Convert.ToInt32(pReader["SuperRetailTraderCount"]);
            }
            if (pReader["CurrentDaySuperRetailTraderOrderAmount"] != DBNull.Value)
            {
                pInstance.CurrentDaySuperRetailTraderOrderAmount = Convert.ToDecimal(pReader["CurrentDaySuperRetailTraderOrderAmount"]);
            }
            if (pReader["LastDaySuperRetailTraderOrderAmount"] != DBNull.Value)
            {
                pInstance.LastDaySuperRetailTraderOrderAmount = Convert.ToDecimal(pReader["LastDaySuperRetailTraderOrderAmount"]);
            }
            if (pReader["CurrentDaySuperRetailTraderOrderAmountDToD"] != DBNull.Value)
            {
                pInstance.CurrentDaySuperRetailTraderOrderAmountDToD = Convert.ToDecimal(pReader["CurrentDaySuperRetailTraderOrderAmountDToD"]);
            }
