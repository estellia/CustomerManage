...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class VipDAO : Base.BaseCPOSDAO, ICRUDable<VipEntity>, IQueryable<VipEntity>
    {
        ...
        public void Create(VipEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("[VipName],[VipLevel],[VipCode],[WeiXin],[WeiXinUserId],[Gender],[Age],[Phone],[IDType],[IDNumber],[SinaMBlog],[TencentMBlog],[Birthday],[Qq],[Email],[Status],[VipSourceId],[Integration],[ClientID],[RecentlySalesTime],[RegistrationTime],[CreateTime],[CreateBy],[LastUpdateTime],[LastUpdateBy],[IsDelete],[APPID],[HigherVipID],[QRVipCode],[City],[CouponURL],[CouponInfo],[MembershipStore],[PurchaseAmount],[PurchaseCount],[DeliveryAddress],[Longitude],[Latitude],[VipPasswrod],[HeadImgUrl],[Col1],[Col2],[Col3],[Col4],[Col5],[Col6],[Col7],[Col8],[Col9],[Col10],[Col11],[Col12],[Col13],[Col14],[Col15],[Col16],[Col17],[Col18],[Col19],[Col20],[Col21],[Col22],[Col23],[Col24],[Col25],[Col26],[Col27],[Col28],[Col29],[Col30],[Col31],[Col32],[Col33],[Col34],[Col35],[Col36],[Col37],[Col38],[Col39],[Col40],[Col41],[Col42],[Col43],[Col44],[Col45],[Col46],[Col47],[Col48],[Col49],[Col50],[VipRealName],[IsActivate],[VIPImportID],[ShareVipId],[SetoffUserId],[ShareUserId],[IsSotre],[UnionID],[VIPID])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@MembershipStore",SqlDbType.NVarChar),
					...
					new SqlParameter("@UnionID",SqlDbType.NVarChar),
            ...
            parameters[8].Value = pEntity.IDType;
            parameters[9].Value = pEntity.IDNumber;
            parameters[10].Value = pEntity.SinaMBlog;
            parameters[11].Value = pEntity.TencentMBlog;
            ...
            parameters[16].Value = pEntity.VipSourceId;
            parameters[17].Value = pEntity.Integration;
            parameters[18].Value = pEntity.ClientID;
            parameters[19].Value = pEntity.RecentlySalesTime;
            parameters[20].Value = pEntity.RegistrationTime;
            ...
            parameters[26].Value = pEntity.APPID;
            parameters[27].Value = pEntity.HigherVipID;
            parameters[28].Value = pEntity.QRVipCode;
            parameters[29].Value = pEntity.City;
            parameters[30].Value = pEntity.CouponURL;
            parameters[31].Value = pEntity.CouponInfo;
            parameters[32].Value = pEntity.MembershipStore;
            parameters[33].Value = pEntity.PurchaseAmount;
            parameters[34].Value = pEntity.PurchaseCount;
            parameters[35].Value = pEntity.DeliveryAddress;
            parameters[36].Value = pEntity.Longitude;
            parameters[37].Value = pEntity.Latitude;
            parameters[38].Value = pEntity.VipPasswrod;
            parameters[39].Value = pEntity.HeadImgUrl;
            parameters[40].Value = pEntity.Col1;
            parameters[41].Value = pEntity.Col2;
            parameters[42].Value = pEntity.Col3;
            parameters[43].Value = pEntity.Col4;
            parameters[44].Value = pEntity.Col5;
            parameters[45].Value = pEntity.Col6;
            parameters[46].Value = pEntity.Col7;
            parameters[47].Value = pEntity.Col8;
            parameters[48].Value = pEntity.Col9;
            parameters[49].Value = pEntity.Col10;
            parameters[50].Value = pEntity.Col11;
            parameters[51].Value = pEntity.Col12;
            parameters[52].Value = pEntity.Col13;
            parameters[53].Value = pEntity.Col14;
            parameters[54].Value = pEntity.Col15;
            parameters[55].Value = pEntity.Col16;
            parameters[56].Value = pEntity.Col17;
            parameters[57].Value = pEntity.Col18;
            parameters[58].Value = pEntity.Col19;
            parameters[59].Value = pEntity.Col20;
            parameters[60].Value = pEntity.Col21;
            parameters[61].Value = pEntity.Col22;
            parameters[62].Value = pEntity.Col23;
            parameters[63].Value = pEntity.Col24;
            parameters[64].Value = pEntity.Col25;
            parameters[65].Value = pEntity.Col26;
            parameters[66].Value = pEntity.Col27;
            parameters[67].Value = pEntity.Col28;
            parameters[68].Value = pEntity.Col29;
            parameters[69].Value = pEntity.Col30;
            parameters[70].Value = pEntity.Col31;
            parameters[71].Value = pEntity.Col32;
            parameters[72].Value = pEntity.Col33;
            parameters[73].Value = pEntity.Col34;
            parameters[74].Value = pEntity.Col35;
            parameters[75].Value = pEntity.Col36;
            parameters[76].Value = pEntity.Col37;
            parameters[77].Value = pEntity.Col38;
            parameters[78].Value = pEntity.Col39;
            parameters[79].Value = pEntity.Col40;
            parameters[80].Value = pEntity.Col41;
            parameters[81].Value = pEntity.Col42;
            parameters[82].Value = pEntity.Col43;
            parameters[83].Value = pEntity.Col44;
            parameters[84].Value = pEntity.Col45;
            parameters[85].Value = pEntity.Col46;
            parameters[86].Value = pEntity.Col47;
            parameters[87].Value = pEntity.Col48;
            parameters[88].Value = pEntity.Col49;
            parameters[89].Value = pEntity.Col50;
            parameters[90].Value = pEntity.VipRealName;
            parameters[91].Value = pEntity.IsActivate;
            parameters[92].Value = pEntity.VIPImportID;
            parameters[93].Value = pEntity.ShareVipId;
            parameters[94].Value = pEntity.SetoffUserId;
            parameters[95].Value = pEntity.ShareUserId;
            parameters[96].Value = pEntity.IsSotre;
            parameters[97].Value = pEntity.UnionID;
            parameters[98].Value = pkString;
        ...
        public VipEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [Vip] where 1=1  and isdelete=0");
            //读取数据
        ...
        public void Update(VipEntity pEntity, bool pIsUpdateNullField, IDbTransaction pTran)
        {
            ...
            if (pIsUpdateNullField || pEntity.IDType != null)
                strSql.Append("[IDType]=@IDType,");
            if (pIsUpdateNullField || pEntity.IDNumber != null)
            ...
            if (pIsUpdateNullField || pEntity.MembershipStore != null)
                strSql.Append("[MembershipStore]=@MembershipStore,");
            ...
            parameters[19].Value = pEntity.RecentlySalesTime;
            parameters[20].Value = pEntity.RegistrationTime;
            parameters[21].Value = pEntity.UnionID;
            parameters[22].Value = pEntity.LastUpdateBy;
            parameters[23].Value = pEntity.APPID;
            parameters[24].Value = pEntity.HigherVipID;
            parameters[25].Value = pEntity.QRVipCode;
            parameters[26].Value = pEntity.City;
            parameters[27].Value = pEntity.CouponURL;
            parameters[28].Value = pEntity.CouponInfo;
            parameters[29].Value = pEntity.MembershipStore;
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Vip] set  isdelete=1 where VIPID=@VIPID;");
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran)
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [Vip] set  isdelete=1 where VIPID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;
            if (pTran == null)
        ...
        public PagedQueryResult<VipEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            ...
            pagedSql.AppendFormat(") as ___rn,* from [Vip] where 1=1  and isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [Vip] where 1=1  and isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
        ...
        protected IWhereCondition[] GetWhereConditionByEntity(VipEntity pQueryEntity)
        {
            ...
            if (pQueryEntity.IDType != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "IDType", Value = pQueryEntity.IDType });
            if (pQueryEntity.IDNumber != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "IDNumber", Value = pQueryEntity.IDNumber });
            ...
            if (pQueryEntity.MembershipStore != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "MembershipStore", Value = pQueryEntity.MembershipStore });
            ...
            if (pQueryEntity.IsSotre != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "IsSotre", Value = pQueryEntity.IsSotre });
        ...
        protected void Load(IDataReader pReader, out VipEntity pInstance)
        {
            ...
            //if (pReader["IDType"] != DBNull.Value)
            //{
            //    pInstance.IDType =  Convert.ToString(pReader["IDType"]);
            //}
            if (pReader["IDNumber"] != DBNull.Value)
            {
                pInstance.IDNumber = Convert.ToString(pReader["IDNumber"]);
            }
            ...
            //if (pReader["MembershipStore"] != DBNull.Value)
            //{
            //    pInstance.MembershipStore =  Convert.ToString(pReader["MembershipStore"]);
            //}
