...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    public partial class VipSnapshotDAO : Base.BaseCPOSDAO, ICRUDable<VipSnapshotEntity>, IQueryable<VipSnapshotEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public VipSnapshotDAO(LoggingSessionInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(VipSnapshotEntity pEntity)
        {
        ...
        public void Create(VipSnapshotEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
			...
			Guid? pkGuid;
			if (pEntity.ShapShotID == null)
				pkGuid = Guid.NewGuid();
			else
				pkGuid = pEntity.ShapShotID;
        ...
        public VipSnapshotEntity GetByID(object pID)
        {
            //参数检查
            if (pID == null)
                return null;
            ...
            sql.AppendFormat("select * from [VipSnapshot] where ShapShotID='{0}'  and isdelete=0 ", id.ToString());
            //读取数据
            VipSnapshotEntity m = null;
        ...
        /// </summary>
        /// <returns></returns>
        public VipSnapshotEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [VipSnapshot] where 1=1  and isdelete=0");
            //读取数据
            List<VipSnapshotEntity> list = new List<VipSnapshotEntity>();
            using (SqlDataReader rdr = this.SQLHelper.ExecuteReader(sql.ToString()))
            {
                while (rdr.Read())
                {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(VipSnapshotEntity pEntity , IDbTransaction pTran)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(VipSnapshotEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            if (!pEntity.ShapShotID.HasValue)
            {
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [VipSnapshot] set ");
            ...
            strSql.Append(" where ShapShotID=@ShapShotID ");
            SqlParameter[] parameters = 
            {
					new SqlParameter("@VIPID",SqlDbType.NVarChar),
					new SqlParameter("@VipName",SqlDbType.NVarChar),
			...
			parameters[23].Value = pEntity.HigherVipID;
			parameters[24].Value = pEntity.QRVipCode;
			parameters[25].Value = pEntity.City;
			parameters[26].Value = pEntity.CouponURL;
			parameters[27].Value = pEntity.CouponInfo;
			parameters[28].Value = pEntity.PurchaseAmount;
			parameters[29].Value = pEntity.PurchaseCount;
			parameters[30].Value = pEntity.DeliveryAddress;
			parameters[31].Value = pEntity.Longitude;
			parameters[32].Value = pEntity.Latitude;
			parameters[33].Value = pEntity.VipPasswrod;
			parameters[34].Value = pEntity.HeadImgUrl;
			parameters[35].Value = pEntity.Col1;
			parameters[36].Value = pEntity.Col2;
			parameters[37].Value = pEntity.Col3;
			parameters[38].Value = pEntity.Col4;
			parameters[39].Value = pEntity.Col5;
			parameters[40].Value = pEntity.Col6;
			parameters[41].Value = pEntity.Col7;
			parameters[42].Value = pEntity.Col8;
			parameters[43].Value = pEntity.Col9;
			parameters[44].Value = pEntity.Col10;
			parameters[45].Value = pEntity.Col11;
			parameters[46].Value = pEntity.Col12;
			parameters[47].Value = pEntity.Col13;
			parameters[48].Value = pEntity.Col14;
			parameters[49].Value = pEntity.Col15;
			parameters[50].Value = pEntity.Col16;
			parameters[51].Value = pEntity.Col17;
			parameters[52].Value = pEntity.Col18;
			parameters[53].Value = pEntity.Col19;
			parameters[54].Value = pEntity.Col20;
			parameters[55].Value = pEntity.Col21;
			parameters[56].Value = pEntity.Col22;
			parameters[57].Value = pEntity.Col23;
			parameters[58].Value = pEntity.Col24;
			parameters[59].Value = pEntity.Col25;
			parameters[60].Value = pEntity.Col26;
			parameters[61].Value = pEntity.Col27;
			parameters[62].Value = pEntity.Col28;
			parameters[63].Value = pEntity.Col29;
			parameters[64].Value = pEntity.Col30;
			parameters[65].Value = pEntity.Col31;
			parameters[66].Value = pEntity.Col32;
			parameters[67].Value = pEntity.Col33;
			parameters[68].Value = pEntity.Col34;
			parameters[69].Value = pEntity.Col35;
			parameters[70].Value = pEntity.Col36;
			parameters[71].Value = pEntity.Col37;
			parameters[72].Value = pEntity.Col38;
			parameters[73].Value = pEntity.Col39;
			parameters[74].Value = pEntity.Col40;
			parameters[75].Value = pEntity.Col41;
			parameters[76].Value = pEntity.Col42;
			parameters[77].Value = pEntity.Col43;
			parameters[78].Value = pEntity.Col44;
			parameters[79].Value = pEntity.Col45;
			parameters[80].Value = pEntity.Col46;
			parameters[81].Value = pEntity.Col47;
			parameters[82].Value = pEntity.Col48;
			parameters[83].Value = pEntity.Col49;
			parameters[84].Value = pEntity.Col50;
			parameters[85].Value = pEntity.VipRealName;
			parameters[86].Value = pEntity.isActivate;
			parameters[87].Value = pEntity.VIPImportID;
			parameters[88].Value = pEntity.ShareVipId;
			parameters[89].Value = pEntity.SetoffUserId;
			parameters[90].Value = pEntity.ShareUserId;
			parameters[91].Value = pEntity.ShapShotID;
        ...
        /// </summary>
        /// <param name="pEntity">实体实例</param>
        public void Update(VipSnapshotEntity pEntity )
        {
        ...
        public void Delete(VipSnapshotEntity pEntity)
        {
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(VipSnapshotEntity pEntity, IDbTransaction pTran)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            ...
            //执行 
            this.Delete(pEntity.ShapShotID.Value, pTran);           
        }
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [VipSnapshot] set  isdelete=1 where ShapShotID=@ShapShotID;");
            SqlParameter[] parameters = new SqlParameter[] 
            { 
                new SqlParameter{ParameterName="@ShapShotID",SqlDbType=SqlDbType.UniqueIdentifier,Value=pID}
            };
            //执行语句
            int result = 0;
            if (pTran != null)
        ...
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Delete(VipSnapshotEntity[] pEntities, IDbTransaction pTran)
        {
            //整理主键值
            ...
            for (int i = 0; i < pEntities.Length; i++)
            {
                ...
                entityIDs[i] = pEntity.ShapShotID;
            }
        ...
        /// </summary>
        /// <param name="pEntities">实体实例数组</param>
        public void Delete(VipSnapshotEntity[] pEntities)
        { 
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran) 
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [VipSnapshot] set  isdelete=1 where ShapShotID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;   
            if (pTran == null)
        ...
        /// <returns></returns>
        public VipSnapshotEntity[] Query(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys)
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [VipSnapshot] where 1=1  and isdelete=0 ");
        ...
        /// <returns></returns>
        public PagedQueryResult<VipSnapshotEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            //组织SQL
            ...
            {
                pagedSql.AppendFormat(" [ShapShotID] desc"); //默认为主键值倒序
            }
            pagedSql.AppendFormat(") as ___rn,* from [VipSnapshot] where 1=1  and isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [VipSnapshot] where 1=1  and isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<VipSnapshotEntity> result = new PagedQueryResult<VipSnapshotEntity>();
            List<VipSnapshotEntity> list = new List<VipSnapshotEntity>();
        ...
        public VipSnapshotEntity[] QueryByEntity(VipSnapshotEntity pQueryEntity, OrderBy[] pOrderBys)
        {
        ...
        /// <param name="pOrderBys">排序组合</param>
        /// <returns>符合条件的实体集</returns>
        public PagedQueryResult<VipSnapshotEntity> PagedQueryByEntity(VipSnapshotEntity pQueryEntity, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            IWhereCondition[] queryWhereCondition = GetWhereConditionByEntity( pQueryEntity);
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(VipSnapshotEntity pQueryEntity)
        { 
            //获取非空属性数量
            List<EqualsCondition> lstWhereCondition = new List<EqualsCondition>();
            if (pQueryEntity.ShapShotID!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "ShapShotID", Value = pQueryEntity.ShapShotID });
        ...
        protected void Load(IDataReader pReader, out VipSnapshotEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new VipSnapshotEntity();
            pInstance.PersistenceHandle = new PersistenceHandle();
            pInstance.PersistenceHandle.Load();

			if (pReader["ShapShotID"] != DBNull.Value)
			{
				pInstance.ShapShotID =  (Guid)pReader["ShapShotID"];
			}
