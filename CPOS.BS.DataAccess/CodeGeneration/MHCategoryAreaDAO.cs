...
namespace JIT.CPOS.BS.DataAccess
{
    ...
    /// 3.实现Load方法
    /// </summary>
    public partial class MHCategoryAreaDAO : Base.BaseCPOSDAO, ICRUDable<MHCategoryAreaEntity>, IQueryable<MHCategoryAreaEntity>
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        ...
        public void Create(MHCategoryAreaEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("[HomeId],[ObjectId],[ObjectTypeId],[GroupId],[Level],[ObjectName],[ImageUrlObject],[Remark],[DisplayIndex],[CreateTime],[CreateBy],[LastUpdateBy],[LastUpdateTime],[IsDelete],[navName],[url],[CategoryAreaId])");
            ...
            SqlParameter[] parameters = 
            {
					...
					new SqlParameter("@navName",SqlDbType.VarChar),
			...
			parameters[3].Value = pEntity.GroupID;
			parameters[4].Value = pEntity.Level;
			parameters[5].Value = pEntity.ObjectName;
			parameters[6].Value = pEntity.ImageUrlObject;
			...
			parameters[14].Value = pEntity.navName;
			parameters[15].Value = pEntity.url;
        ...
        public void Update(MHCategoryAreaEntity pEntity , IDbTransaction pTran,bool pIsUpdateNullField)
        {
            ...
            if (pIsUpdateNullField || pEntity.navName!=null)
			...
			parameters[11].Value = pEntity.navName;
			parameters[12].Value = pEntity.url;
			parameters[13].Value = pEntity.CategoryAreaId;
        ...
        { 
            ...
            if (pQueryEntity.navName!=null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "navName", Value = pQueryEntity.navName });
        ...
        protected void Load(IDataReader pReader, out MHCategoryAreaEntity pInstance)
        {
			...
			if (pReader["navName"] != DBNull.Value)
			{
				pInstance.navName =  Convert.ToString(pReader["navName"]);
			}
