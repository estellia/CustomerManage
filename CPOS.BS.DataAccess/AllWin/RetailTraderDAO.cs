...
namespace JIT.CPOS.BS.DataAccess
{
	...
	public partial class RetailTraderDAO : Base.BaseCPOSDAO, ICRUDable<RetailTraderEntity>, IQueryable<RetailTraderEntity>
	{
        ...
        public DataSet GetMultiLevelBeAddNode(string RetailTraderId)
        {
            ...
            parm[0] = new SqlParameter("@RetailTraderId", System.Data.SqlDbType.VarChar) { Value = RetailTraderId };

            return this.SQLHelper.ExecuteDataset(CommandType.StoredProcedure, "Proc_MultiLevelBeAddNode", parm);
        ...
        public DataSet GetMultiLevelSalerQuery(string RetailTraderId)
        {
			...
			return this.SQLHelper.ExecuteDataset(CommandType.StoredProcedure, "Proc_MultiLevelSalerQuery", parm);
		}
...
where a.CustomerId=@CustomerId  AND    a.isdelete = 0   {4} ";
		...
		public DataSet GetVMultiLevelSalerConfig(string sql)
		{
