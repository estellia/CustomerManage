...
namespace JIT.CPOS.BS.Web.ApplicationInterface
{
    /// <summary>
    /// 接口处理器工厂 
    /// </summary>
    public static class ActionHandlerFactory
    {
        ...
        /// 产品接口的处理类的基本命名空间
        /// </summary>
        const string PRODUCT_ACTION_HANDLER_BASE_NAMESPACE = "JIT.CPOS.BS.Web.ApplicationInterface.Module";

        /// <summary>
        /// 项目接口的处理类的基本命名空间
        /// </summary>
        const string PROJECT_ACTION_HANDLER_BASE_NAMESPACE = "JIT.CPOS.BS.Web.ApplicationInterface.Project";

        /// <summary>
        /// 演示接口的处理类的基本命名空间
        /// </summary>
        const string DEMO_ACTION_HANDLER_BASE_NAMESPACE = "JIT.CPOS.BS.Web.ApplicationInterface.Demo";
