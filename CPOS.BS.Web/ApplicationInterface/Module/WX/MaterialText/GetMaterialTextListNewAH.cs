...
namespace JIT.CPOS.BS.Web.ApplicationInterface.Module.WX.MaterialText
{
    ...
    public class GetMaterialTextListNewAH : BaseActionHandler<GetMaterialTextListRP, MaterialTextListRD>
    {
        protected override MaterialTextListRD ProcessRequest(DTO.Base.APIRequest<GetMaterialTextListRP> pRequest)
        {
            var rd = new MaterialTextListRD();
            ...
            var list = entitys.Select(t => new MaterialTextList
