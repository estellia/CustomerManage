...
{
    public class GetT_CTW_LEventListAH : BaseActionHandler<GetT_CTW_LEventListRP, GetT_CTW_LEventListRD>
    {

        protected override GetT_CTW_LEventListRD ProcessRequest(APIRequest<GetT_CTW_LEventListRP> pRequest)
        {
            var rd = new GetT_CTW_LEventListRD();
