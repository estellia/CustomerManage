...
{
    public class GeEventItemDetailListAH : BaseActionHandler<GeEventItemDetailListRP, GeEventItemDetailListRD>
    {
        protected override GeEventItemDetailListRD ProcessRequest(APIRequest<GeEventItemDetailListRP> pRequest)
        {
            var rd = new GeEventItemDetailListRD();
            ...
            DataSet ds = _T_CTW_LEventBLL.GeEventItemDetailList(
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    rd.EventItemDetailList = DataTableToObject.ConvertToList<EventItemDetailInfo>(ds.Tables[1]);
                }
