...
namespace JIT.CPOS.BS.Web.ApplicationInterface.Module.Item
{
    ...
    public class ItemNewHandler : BaseGateway
    {
        ...
        public string GetItemType()
        {
            ...
            //新干线项目建虚拟商品只显示优惠券
            rd.VirtualItemTypeInfo = bllSysVirtualItemType.QueryByEntity(new SysVirtualItemTypeEntity() { IsDelete = 0, VirtualItemTypeCode = "Coupon" }, null).ToList();
    ...
    public class SaveItemDataRP : IAPIRequestParameter
    {
        ...
        /// 虚拟商品集合（一个虚拟商品代表一个套餐）
        /// </summary>
        public IList<T_VirtualItemTypeSettingEntity> VirtualItems { get; set; }

        /// <summary>
        /// 商品配送设置
        /// </summary>
        public IList<T_Item_Delivery_MappingEntity> ItemDeliverySettings { get; set; }
