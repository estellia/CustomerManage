Ext.define("ContorlEEnterpriseCustomerSourceEntity", {
    ...
    fields: [{
        ...
        name: "text",
        mapping:"ECSourceName",
        type: "string"
    }]
});

// ZCourse 业务控件
Ext.define('jit.biz.EEnterpriseCustomerSource', {
    alias: 'widget.jitbizeenterprisecustomersource',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlEEnterpriseCustomerSourceEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EEnterpriseCustomerSourceHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
