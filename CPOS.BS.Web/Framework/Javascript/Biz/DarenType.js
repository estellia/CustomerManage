Ext.define("ContorlDarenTypeEntity", {
...
// EventType 业务控件
Ext.define('jit.biz.DarenType', {
    alias: 'widget.jitbizdarentype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            //pageSize: args.pageSize || 15,
            model: "ContorlDarenTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/DarenType.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
