Ext.define("ContorlEEnterpriseCustomerTypeEntity", {
...
// ZCourse 业务控件
Ext.define('jit.biz.EEnterpriseCustomerType', {
    alias: 'widget.jitbizeenterprisecustomertype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlEEnterpriseCustomerTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EEnterpriseCustomerTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
