...
// WMenuSelectTree 业务控件
Ext.define('Jit.Biz.WMenuSelectTree', {
    alias: 'widget.jitbizwmenuselecttree',
    constructor: function (args) {
        ...
        Ext.Ajax.request({
            url: "/Framework/Javascript/Biz/Handler/WMenuSelectTreeHandler.ashx?method=&parent_id=" + args.parentId,
            method: 'GET',
            async: false,
