Ext.define("ContorlTagsTypeEntity", {
...
// TagsType 业务控件
Ext.define('jit.biz.TagsType', {
    alias: 'widget.jitbiztagstype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlTagsTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/TagsTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
