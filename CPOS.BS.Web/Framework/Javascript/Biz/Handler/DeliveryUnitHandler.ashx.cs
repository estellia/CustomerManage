...
{
    /// <summary>
    /// DeliveryUnitHandler 的摘要说明
    /// </summary>
    public class DeliveryUnitHandler : JIT.CPOS.BS.Web.PageBase.JITCPOSAjaxHandler, 
        IHttpHandler, IRequiresSessionState
    {
        ...
        protected override void AjaxRequest(HttpContext pContext)
        {
            ...
            switch (pContext.Request["method"])
            {
                ...
                //    break;
                case "get_delivery_unit":
                default:
                    content = GetDeliveryUnit();
                    break;
            }
        ...
        ///// <param name="pParentID">传入</param>
        ///// <returns>success是代表存在树</returns>
        //private string GetDeliveryUnit(string pParentID)
        //{
