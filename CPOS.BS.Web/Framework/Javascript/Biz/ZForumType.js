Ext.define("ContorlZForumTypeEntity", {
    ...
    fields: [{
        ...
        name: "text",
        mapping:"ForumTypeName",
        type: "string"
    }]
});

// ZCourse 业务控件
Ext.define('jit.biz.ZForumType', {
    alias: 'widget.jitbizzforumtype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlZForumTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/ZForumTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
