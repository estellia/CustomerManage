Ext.define("ContorlUnitSortEntity", {
...
// UnitSort 业务控件
Ext.define('jit.biz.UnitSort', {
    alias: 'widget.jitbizunitsort',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlUnitSortEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/UnitSortHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
