Ext.define("ContorlEventModeEntity", {
    ...
    fields: [{
        ...
        name: "text",
        mapping:"EventModeDesc",
        type: "string"
    }]
});

// EventMode 业务控件
Ext.define('jit.biz.EventMode', {
    alias: 'widget.jitbizeventmode',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            //pageSize: args.pageSize || 15,
            model: "ContorlEventModeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        if (args.dataType == undefined || args.dataType == null) {
            args.dataType = "EventMode";
        }
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EventModeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
