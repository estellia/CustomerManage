Ext.define("ContorlVipSourceEntity", {
...
// VipSource 业务控件
Ext.define('jit.biz.VipSource', {
    alias: 'widget.jitbizvipsource',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlVipSourceEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/VipSourceHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
