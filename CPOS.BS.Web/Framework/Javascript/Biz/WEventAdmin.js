Ext.define("ContorlWEventAdminEntity", {
...
// WEventAdmin 业务控件
Ext.define('jit.biz.WEventAdmin', {
    alias: 'widget.jitbizweventadmin',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlWEventAdminEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/WEventAdminHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
