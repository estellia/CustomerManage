Ext.define("ContorlEScaleEntity", {
...
// ZCourse 业务控件
Ext.define('jit.biz.EScale', {
    alias: 'widget.jitbizescale',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlEScaleEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EScaleHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
