Ext.define("ContorlMobileModuleEntity", {
...
//Options业务控件
Ext.define('Jit.biz.MobileModule', {
    alias: 'widget.jitbizmobilemodule',
    constructor: function (args) {
        ...
        var store = new Ext.data.Store({
            ...
            model: "ContorlMobileModuleEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json'
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/OptionsHandler.ashx?method=GetMobileModule";
