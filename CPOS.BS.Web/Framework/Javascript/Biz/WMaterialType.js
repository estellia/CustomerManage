Ext.define("ContorlWMaterialTypeEntity", {
    ...
    fields: [{
        ...
        name: "text",
        mapping:"MaterialTypeName",
        type: "string"
    }]
});

// WMaterialType 业务控件
Ext.define('jit.biz.WMaterialType', {
    alias: 'widget.jitbizwmaterialtype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlWMaterialTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/WMaterialTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
