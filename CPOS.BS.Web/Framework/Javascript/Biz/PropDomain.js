Ext.define("ContorlPropDomainEntity", {
...
// PropDomain 业务控件
Ext.define('jit.biz.PropDomain', {
    alias: 'widget.jitbizpropdomain',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlPropDomainEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/PropDomainHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
