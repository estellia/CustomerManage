Ext.define("ContorlEPolicyDecisionRoleEntity", {
...
// ZCourse 业务控件
Ext.define('jit.biz.EPolicyDecisionRole', {
    alias: 'widget.jitbizepolicydecisionrole',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlEPolicyDecisionRoleEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EPolicyDecisionRoleHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
