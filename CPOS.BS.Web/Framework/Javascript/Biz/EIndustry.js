Ext.define("ContorlEIndustryEntity", {
...
// ZCourse 业务控件
Ext.define('jit.biz.EIndustry', {
    alias: 'widget.jitbizeindustry',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlEIndustryEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/EIndustryHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
