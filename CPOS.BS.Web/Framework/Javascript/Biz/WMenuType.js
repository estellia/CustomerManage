Ext.define("ContorlWMenuTypeEntity", {
...
// WMenuType 业务控件
Ext.define('jit.biz.WMenuType', {
    alias: 'widget.jitbizwmenutype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlWMenuTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/WMenuTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
