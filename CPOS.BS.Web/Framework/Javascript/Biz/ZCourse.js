Ext.define("ContorlZCourseEntity", {
...
// ZCourse 业务控件
Ext.define('jit.biz.ZCourse', {
    alias: 'widget.jitbizzcourse',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlZCourseEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/ZCourseHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
            params: {  }
