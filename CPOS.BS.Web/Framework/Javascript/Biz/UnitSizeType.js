Ext.define("ContorlUnitSizeTypeEntity", {
...
// EventType 业务控件
Ext.define('jit.biz.UnitSizeType', {
    alias: 'widget.jitbizunitsizetype',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            //pageSize: args.pageSize || 15,
            model: "ContorlUnitSizeTypeEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/UnitSizeTypeHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
