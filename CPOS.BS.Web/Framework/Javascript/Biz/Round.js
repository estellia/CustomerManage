...
// Round 业务控件
Ext.define('jit.biz.Round', {
    alias: 'widget.jitbizround',
    constructor: function (args) {
        var store = new Ext.data.Store({
            storeId: args.storeId,
            model: "ContorlRoundEntity",
            proxy: {
                type: 'ajax',
                reader: {
                    type: 'json',
        ...
        store.proxy.url = "/Framework/Javascript/Biz/Handler/RoundHandler.ashx?method=" + args.dataType;
        store.load({
            //limit: 10,
            //page: 0
        });
