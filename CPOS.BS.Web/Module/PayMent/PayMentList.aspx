...
<div id="jui-dialog-AlipayWap" class="jui-dialog jui-dialog-payMent">
    ...
    <div class="payMentContent">
        ...
        <div class="commonSelectWrap" style="margin:3px 0 38px">
            <em class="tit">支付方式:</em>
            <div class="checkWrap">
                <p id="pagePay" class="checkBox" data-value='pagePay'>网页支付</p>
                <p id="scanCodePay" class="checkBox" data-value="scanCodePay">扫码支付<strong>目前仅用于掌柜APP售卡和充值，
如果不启用则不显示支付方式。</strong></p>
            </div>
        </div>
