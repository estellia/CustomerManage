    ...
    var pTree = new Ext.create('Ext.tree.TreePanel', {
        ...
        listeners: {
            'itemcontextmenu': function (menutree, record, items, index, e) {                
                ...
                menuPropsku = record.data.ID;
                rightMenu.showAt(e.getXY());
            },
            'itemclick': function (view, re) {
                get("tree_selected").value = re.data.ID;
                get("tree_prop_type").value = re.data.prop_type;
                get("propInputFlag").value = re.data.prop_input_flag;

                if (re.data.prop_input_flag != "select") {
                    $("#span_create").hide();
                }
                else {
                    $("#span_create").show();
