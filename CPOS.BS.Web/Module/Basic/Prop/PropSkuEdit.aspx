...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="<%=StaticUrl+"/Module/basic/prop/Controller/PropSkuEditCtl.js?v=0.2"%>" type="text/javascript"></script>
    ...
    <script src="<%=StaticUrl+"/Module/basic/prop/View/PropSkuEditView.js"%>" type="text/javascript"></script>
                    ...
                    <div class="z_detail_tb" style="">
                        ...
                        <table class="z_main_tb">
                            ...
                            <tr class="z_main_tb_tr">
                                <td id="txtParenttitle" class="z_main_tb_td" style="vertical-align:top; line-height:22px; width:120px;">
                                    上级节点</td>
                            ...
                            <tr class="z_main_tb_tr">
                                <td class="z_main_tb_td" id="txtNameTitle" style="vertical-align:top; line-height:22px; width:120px;">
