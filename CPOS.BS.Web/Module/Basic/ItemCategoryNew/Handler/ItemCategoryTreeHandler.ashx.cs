...
namespace JIT.CPOS.BS.Web.Module2.BaseData.ItemCategory.Handler
{
    ...
    public class ItemCategoryTreeHandler : JITCPOSTreeHandler
    {
        ...
        public int GetLevel(string parentID, List<ItemCategoryInfo> list)
        {
            //return 0;
            ...
            else
            {
                ...
                var parent = list.FirstOrDefault(x => x.Item_Category_Id == parentID);
                //parent = bll.GetItemCategoryById(parentID);
                if (parentID != null )
                {
                    if (parent == null)
                    {
                    ...
                    return GetLevel(parent.Parent_Id,list) + 1;
                }
            }
            return 0;
        }
