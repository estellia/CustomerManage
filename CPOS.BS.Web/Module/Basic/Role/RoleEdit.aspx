...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="<%=StaticUrl+"/module/basic/role/Controller/RoleEditCtl.js"%>" type="text/javascript"></script>
    <script src="<%=StaticUrl+"/module/basic/role/Model/RoleVM.js"%>" type="text/javascript"></script>
    <script src="<%=StaticUrl+"/module/basic/role/Model/RoleDetailVM.js"%>" type="text/javascript"></script>
    <script src="<%=StaticUrl+"/module/basic/role/Store/RoleVMStore.js"%>" type="text/javascript"></script>
    <script src="<%=StaticUrl+"/module/basic/role/View/RoleEditView.js"%>" type="text/javascript"></script>
