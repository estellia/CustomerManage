...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="/Framework/javascript/Biz/TagsStatus.js" type="text/javascript"></script>
    <script src="/Framework/javascript/Biz/TagsType.js" type="text/javascript"></script>
                        ...
                        <table class="z_main_tb">
                            ...
                            <tr class="z_main_tb_tr">
                                <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;">
                                    标签状态</td>
                                <td class="z_main_tb_td2" colspan="5" style="padding-top:0px;">
                                    <div id="txtStatusId"></div>
                                </td>
                            </tr>
                            <tr class="z_main_tb_tr">
                                <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;">
                                    <font color="red">*</font>标签描述</td>
                                <td class="z_main_tb_td2" colspan="5" style="padding-top:0px;">
