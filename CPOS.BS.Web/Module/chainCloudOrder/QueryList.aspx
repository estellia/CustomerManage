        ...
        <div class="allPage" id="section" data-js="js/queryList.js?ver=0.4">
            ...
            <div class="contentArea_vipquery">
                ...
                <div class="optionBtn">
                               ...
                               <div class="commonBtn optionCheck sales" id="optBtnss" data-flag="add" data-show="1234567890,占位"  style="display: none">配发货门店</div>
                                  </div>
      ...
      <div style="display:none;">
       ...
       <script id="tpl_OrderCancel" type="text/html">
        ...
        <script id="tpl_setUnit" type="text/html">
          ...
          <div class="commonSelectWrap" style="width: 100%;margin-bottom: 20px;">
                                        <em class="tit">门店：</em>
                                        <div class="selectBox" >
