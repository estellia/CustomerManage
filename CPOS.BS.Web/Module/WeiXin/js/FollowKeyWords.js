define(['jquery', 'tools', 'template', 'kindeditor', 'lang', 'pagination', 'drag','easyui'], function () {
    ...
    var page =
        {
            ...
            loadMoreMaterial: function (currentPage) {
                ...
                this.loadData.getMaterialTextList("", function (data) {
                    ...
                    that.events.initPagination(currentPage, data.Data.TotalPages);
                });
                ...
                this.events.elems =
        {
                ...
                switch (messageType - 0) {
                    ...
                    case 3:
                        ...
                        var obj = {
                            ...
                            itemList: keyInfo.MaterialTextIds||that.storage
                        }
                        that.storage = keyInfo.MaterialTextIds||that.storage;
                        var html = bd.template("addImageItemTmpl", obj);
            ...
            saveData: function ($this) {
                ...
                var messageType = this.elems.messageSelect.val();
                ...
                $.util.ajax({
                    ...
                    data:
                    {
                        'action': 'WX.KeyWord.SaveDefaultKeyWord',
                        'KeyWordList': {
    ...
    page.loadData =
    {
        ...
        //获得关键字的详细内容
        getDefaultKeyword: function (callback) {
            $.util.ajax({
                url: page.url,
                type: "post",
                data:
                {
                    'action': 'WX.KeyWord.GetDefaultKeyWord',
        ...
        searchKeywords: function (callback) {
            $.util.ajax({
                ...
                data:
                {
                    ...
                    'PageSize': page.keyword.pageSize
                },
                success: function (data) {
                    if (data.ResultCode == 0) {
                        //表示成功
