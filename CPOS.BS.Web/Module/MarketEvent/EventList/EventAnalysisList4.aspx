...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <iframe id="frmRep" src="http://o2oapi.aladingyidong.com/wap/Event/MarketEvent20131208/c.htm?eventId=<%=CurrentUserInfo.CurrentUserRole.RoleName %>&marketEventId=<%=CurrentUserInfo.CurrentUserRole.RoleName %>&customerId=<%=CurrentUserInfo.CurrentUser.customer_id %>" 
