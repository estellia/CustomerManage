...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="View/VipCardReportLossView.js" type="text/javascript"></script>
    <script src="Controller/VipCardReportLossCtl.js" type="text/javascript"></script>
                ...
                <div style="width:100%;">
                    <div class="" style="">
                        ...
                        <div class="z_card_row" style="color:red;">
                            <div style="float:left;">提示：如卡状态为锁定，请立即做冻结处理。</div>
                        </div>
