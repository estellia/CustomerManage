...
fnLoad = function() {
    ...
    Ext.Ajax.request({
        ...
        success: function (response) {
            ...
            Ext.getCmp("txtDormancyTime").setValue(getStr(d.DormancyTime));
...
function fnSave() {
    ...
    Ext.Ajax.request({
        ...
        sync: true,
        async: false,
        url: '/Module/VipCard/Search/Handler/VipCardSearchHandler.ashx?method=SaveVipCardSleep&VipCardId=' + vip.VipCardID, 
        params: {
            "vip": Ext.encode(vip)
        },
