          	...
          	<div class="borderArea">
                <div class="inlineBlockArea">
                      ...
                      <div class="commonSelectWrap">
                        <em class="tit">电话：</em>
                        <label class="searchInput clearBorder">
                          <input data-text="电话" class="easyui-validatebox"  data-flag="Telephone" id="Telephone" name="Telephone" type="text" data-options="required:true,validType:'mobileTelephone'"  value="" placeholder="请输入">
                        </label>
                      </div>
