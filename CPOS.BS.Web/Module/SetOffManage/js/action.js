define(['jquery', 'template', 'tools', 'langzh_CN', 'easyui', 'kkpager', 'artDialog', 'highcharts', 'kindeditor', 'noviceGuideJS'], function ($) {
    ...
    var page = {
        ...
        initEvent: function () {
                ...
                that.GetModuleNextStep({
                    ...
                    if (stepIndex !=4) {
                        var Step = new noviceGuide("Step", {
                            ...
                            isShow: true,
                            title: "拓展新会员",
                            content: "设置员工和会员的集客激励方案，</br>在集客工具中添加优惠券和集客海报。",
                        ...
                        $("body").animate({ scrollTop: $('#guidePrompt_Step').offset().top }, 1000);
                    } else {
                        var test2 = new noviceGuide("test2", {
                            ...
                            isShow: true,
                            title: "鼓励店员会员集客",
                            content: "确认集客行动信息，</br>向员工和会员发送集客行动内容通知。",
                            step: data.NowModule.ModuleStep,
                            sumStep: 6,
                            video: {
                                // top: 250,
            ...
            //var step2 = new noviceGuide("step2", {
            //    top: "1150",
            //    left: "350",
            //    isShow: false,
            //    title: "鼓励店员会员集客",
            ...
            //}, function () {
            //    step2.closeGuide();
            //    window.location.href = "/module/SetOffManage/source.aspx"
            //});
                        ...
                        if(lockRule=='10'){
                            ...
                            inputs.each(function(j){
                                ...
                                if(j==0){
                                    ...
                                    if($tt.val()=="0"){
                                        $.messager.alert('提示','员工集客活动注册成功奖励不能为0');
                                        $tt.css('border','1px solid red');
                                        isSuccess=false;
                                        return false;
                                    }
                                ...
                                if(j==1){
                                   /* if($tt.val()==""){
                                    ...
                                    if($tt.val()=="0"){
                                        $.messager.alert('提示','员工集客活动销售成功奖励不能为0');
                                        $tt.css('border','1px solid red');
                                        isSuccess=false;
                                        return false;
                                    }*/
                        ...
                        if(lockRule=='10'){
                            ...
                            inputs.each(function(j){
                                ...
                                if(j==3){
                                    ...
                                    if($tt.val()=="0"){
                                        $.messager.alert('提示','会员集客活动注册成功奖励不能为0');
                                        $tt.css('border','1px solid red');
                                        isSuccess=false;
                                        return false;
                                    }
                                ...
                                if(j==4){
                                    ...
                                    if($tt.val()=="0"){
                                        $.messager.alert('提示','会员集客活动销售成功奖励不能为0');
                                        $tt.css('border','1px solid red');
                                        isSuccess=false;
                                        return false;
                                    }
        ...
        loadPageData: function (e) {
			...
			if($.util.version==3){
				var $toolData = $('.toolData ul li'),
					$tableWrap = $('#tableWrap ul li');
				$toolData.eq(0).hide();
				$toolData.eq(1).addClass('current');
				$('#StaffActionTool').hide();
				$('#VipActionTool').hide();
				
				$tableWrap.eq(0).hide();
				$tableWrap.eq(1).addClass('on');
			}
        ...
        getAction:function(data){
            ...
            for(var i =0;i<list.length;i++){
                ...
                $($('.toolData .title').find('li').get(1)).trigger('click');
