...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="allPage" id="section" data-js="js/action.js?ver=0.2" >
        <!-- 内容区域 -->
         <!-- 员工集客 -->
                ...
                <div class="blockModul">
                    ...
                    <div class="contents" style="height:220px;">
                        ...
                        <form>
                            ...
                            <div class="editArea"><label><span class="title">集客销售成功奖励</span><input type="text" class="setoffOrderPer" readonly="readonly">%不填表示不启用集客销售奖励</label></div>
            ...
            <#for(var i=0;i<list.length;i++){ var item=list[i];#>
                <#if(item.ToolType=="Coupon"){#>
                    <li data-id="<#=item.ObjectId#>" data-time="<#=item.ValidityPeriod#>" data-new="true" data-type="2" data-toolid="<#=item.SetoffToolID#>">
                        <label>
                            <p><b><#=i+1#>.</b><span class="name"><#=item.Name#></span>
                ...
                <#}else{#>
                    ...
                    <label>
                        <p><b><#=i+1#>.</b><span class="name"><#=item.CouponTypeName#></span>
                        <#if(item.IsNotLimitQty=="1"){#>
                            <span class="till">不限数量</span>
                        <#}else{#>
