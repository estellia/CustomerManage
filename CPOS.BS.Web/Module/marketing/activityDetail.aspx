                    ...
                    <div class="panelDiv" id="nav02" data-index="1">
                        ...
                        <!--tagPanel-->
                         <div class="tagPanel" style="display: none;">
                                                    <div class="checkBoxPanel">
                                                        <div class="inputDiv">
                                                            <div class="checkBox" data-filed="AmountLimit" data-name="numberBoxAndOpt">
                                                                <em></em><span>消费满：</span></div>
                                                               <div style="float: left;margin-right:15px; ">
                                                               <input type="text" data-name="AmountLimit" name="AmountLimit" class="easyui-numberbox" data-options="min:0,precision:2,max:10000,width:120,height:32">元送券
                                                              </div>
                                                              <div class="checkBox numberBoxAndOpt" data-filed="IsCirculation" >
                                                                 <em></em><span>叠加送</span></div>
                                                            <div class="optPanel numberBoxAndOpt">
                                                                <div class="commonBtn" data-prizestype="2" data-prizesid="">选择券</div>
                                                                <em class="hint">持卡人数：10,000 人</em>
                                                            </div>
                                                        </div>
                                                        <!--inputDiv-->
                                                    ...
                                                    <!--checkBoxPanel-->
                                                    <div class="tablePanel numberBoxAndOpt">
                                                        <div class="gridTable">
                                                        </div>
                                                    </div>
                                                    <!--tablePanl-->
                                      ...
                                      <div class="templatePanel " data-message="">
                                               <div class="panelSel">
                                                                          <div class="commonSelectWrap">
                                                                              <em class="tit">活动前</em>
                                                                              <div class="selectBox">
                                                                                  <input class="easyui-combobox" data-name="day" data-options="width:90,height:32,required:true,validType:'selectIndex',
                                                                     valueField: 'value',
                                                                     textField: 'label',
                                                                     onSelect:onSelectDay,
                                                                     data: [{
                                                                           ...
                                                                           },
                                                                           {
                                                                              ...
                                                                              selected:true
                                                                                  ...
                                                                                  <input class="easyui-combobox" data-name="hour" data-options="width:90,height:32,required:true,validType:'selectIndex',
                                                                     valueField: 'value',
                                                                     textField: 'label',
                                                                     onSelect:onSelectHour,
                                                                     data: [
