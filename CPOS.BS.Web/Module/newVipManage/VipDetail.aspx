...
<div class="linePanel">
                   ...
                   <div class="commonSelectWrap widthMax">
                    ...
                    data-options="width:200,height:30,validType:'dateTime'"   /></div>
   ...
   <div class="lineTitle "><em></em> 账户信息</div>
     <div class="linePanel">
         <div class="adjustList">
                     ...
                     <!--adjustList-->
                     <div class="adjustList" style="display:none">
                          <div class="commonSelectWrap">
...
<!--linePanel-->
        ...
        <div>
            ...
            <div class="subMenu lineTitle">
                ...
                <li data-id="nav011" class="nav011" style="display:none">返现记录</li>
 ...
 <script id="tpl_adjustIntegral" type="text/html">
    ...
    <form id="optionform">
         ...
         <div class="commonSelectWrap" style="float: none; width: 500px;">
                                <em class="tit">调整数量：</em>
                               <div class="searchInput bonone">
                                  <input type="text" name="Amount" class="easyui-numberbox"  data-options="precision:2,width:100,height:32,required:true,"  />
                              </div>
                          </div>
         <div class="commonSelectWrap">
                                <em class="tit">原因：</em>
