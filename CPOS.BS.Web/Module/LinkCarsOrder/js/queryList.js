define(['jquery', 'template', 'tools','langzh_CN','easyui', 'kkpager'], function ($) {
    ...
    var page = { 
        ...
        initEvent: function () {
            ...
            //针对模拟的下拉框进行事件绑定
            //$.util.selectEvent("#simpleQuery,#showDetail,#operation");
            var  wd=160,H=32;
            $('#payment').combobox({
                width:wd,
                height:H,
       ...
       cancelOrder:function(data){
                ...
                frozenColumns:[[
                    ...
                    {field : 'OrderID',title : '操作',width:96,align:'center',resizable:false,
                        formatter:function(value ,row,index){
                            ...
                            if($.util.GetDateDiff( $.FormatDateTime(new Date()),row.ReserveTime,"day")>=1&&row.Status!=6&&row.Status!=10&&row.Status!=11){
        ...
        hideElements: function (selector,isHideUiMask) {
            if(!isHideUiMask) {
       ...
       loadData: {
            ...
            getCarOderList: function (callback) {
                ...
                prams.data={
                    ...
                    UnitID:window.RoleCode=="Admin"?null:window.UnitID,//
