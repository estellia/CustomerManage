                        ...
                        <div class="item">
                          ...
                          <form id="seach">
                              ...
                              <div class="commonSelectWrap">
                                  <em class="tit">手机：</em>
                                  <label class="searchInput" style="width:232px;">
                                      <input data-text="手机" class="easyui-validatebox" data-flag="User_Telephone" name="User_Telephone" id="User_Telephone" type="text" value="" data-options="validType:'mobile'" placeholder="请输入">
                                  </label>
                              </div>
