<%@ Page Title="商品" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/SalesOutOrderItemCreateCtl.js" type="text/javascript"></script>
    ...
    <script src="Store/SalesOutOrderItemVMStore.js" type="text/javascript"></script>
    <script src="View/SalesOutOrderItemCreateView.js" type="text/javascript"></script>
            ...
            <div style="width:100%; padding:10px; padding-bottom:0px; 
                ...
                <div style="width:100%; padding-left:10px; padding-right:10px;">
                    <table class="z_main_tb">
                        ...
                        <tr class="z_main_tb_tr">
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>单价（元）</td>
                        ...
                        <%--<tr class="z_main_tb_tr">
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>预定数量</td>
                            <td class="z_main_tb_td2" style="vertical-align:top; line-height:32px;">
