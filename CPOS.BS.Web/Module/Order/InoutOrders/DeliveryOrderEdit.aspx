<%@ Page Title="配送订单明细" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/DeliveryOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="Store/DeliveryOrderVMStore.js" type="text/javascript"></script>
    <script src="View/DeliveryOrderEditView.js" type="text/javascript"></script>
