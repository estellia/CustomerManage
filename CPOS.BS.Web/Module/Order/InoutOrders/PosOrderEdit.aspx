<%@ Page Title="POS小票" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/PosOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/PosOrderEditView.js" type="text/javascript"></script>
