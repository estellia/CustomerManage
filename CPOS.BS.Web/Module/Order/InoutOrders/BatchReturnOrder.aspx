<%@ Page Title="批发退货单管理" Language="C#" MasterPageFile="~/Framework/MasterPage/CPOS.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/BatchReturnOrderCtl.js" type="text/javascript"></script>
    ...
    <script src="View/BatchReturnOrderView.js" type="text/javascript"></script>
