<%@ Page Title="销售退货入库单" Language="C#" MasterPageFile="~/Framework/MasterPage/CPOS.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/SalesReturnInOrderCtl.js" type="text/javascript"></script>
    ...
    <script src="View/SalesReturnInOrderView.js" type="text/javascript"></script>
