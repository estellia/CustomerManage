    ...
    if (order_id != "null" && order_id != "") {
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                Ext.getCmp("txtPurchaseWarehuouse").jitSetValue(d.warehouse_name);
...
function fnClose() {
    CloseWin('PurchaseReturnOrderEdit');
}
...
function fnSave() {
    ...
    Ext.Ajax.request({
        ...
        sync: true,
        async: false,
        url: 'Handler/InoutHandler.ashx?method=PurchaseReturnOutOrder_Save&order_id=' + order_id,
