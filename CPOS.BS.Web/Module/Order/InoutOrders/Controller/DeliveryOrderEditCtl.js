    ...
    if (order_id != "null" && order_id != "") {
        Ext.Ajax.request({
            ...
            success: function (response) {
                var storeId = "deliveryOrderEditStore";
                ...
                Ext.getCmp("txtPayName").setValue(getStr(d.payment_name));
                Ext.getCmp("txtKeepTheChange").setValue(getStr(d.keep_the_change));
                Ext.getCmp("txtWipingZero").setValue(getStr(d.wiping_zero));
                Ext.getCmp("txtVipNo").setValue(getStr(d.vip_name));
                
                Ext.getCmp("txtCarrier").setValue(getStr(d.carrier_name));
                Ext.getCmp("txtField1").setValue(getStr(d.Field1));
                Ext.getCmp("txtField2").setValue(getStr(d.Field2));
                Ext.getCmp("txtField3").setValue(getStr(d.Field3));
                ...
                Ext.getCmp("txtField7").setValue(getStr(d.Field7));
...
function fnLoadItems() {
    var storeId = "deliveryOrderEditItemStore";
    //debugger;
...
function fnSave() {
    //    //debugger;
    var _grid = Ext.getStore("deliveryOrderEditItemStore");
    var order = {};
    var flag = false;
