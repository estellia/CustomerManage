...
function fnCreate() {
    //window.location = "PurchaseInOrderEdit.aspx?mid=" + __mid + "&op=new";
    var win = Ext.create('jit.biz.Window', {
        jitSize: "large",
        height: detailWinHeight,
        id: "PurchaseInOrderEdit",
        title: "采购入库单",
        url: "PurchaseInOrderEdit.aspx?mid=" + __mid + "&op=new"
    });
    win.show();
...
function fnSearch() {
    Ext.getStore("purchaseInOrderStore").proxy.url = JITPage.HandlerUrl.getValue()
        + "&method=PurchaseInOrder";
    Ext.getStore("purchaseInOrderStore").pageSize = JITPage.PageSize.getValue();
    Ext.getStore("purchaseInOrderStore").proxy.extraParams = {
    ...
    Ext.getStore("purchaseInOrderStore").load();
}
...
function fnView(id,op) {
    ...
    var win = Ext.create('jit.biz.Window', {
        ...
        id: "PurchaseInOrderEdit",
        title: "采购入库订单",
        url: "PurchaseInOrderEdit.aspx?order_id=" + id + "&op=" + op
    });
    win.show();
