<%@ Page Title="销售出库单明细" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/SalesOrderCreateCtl.js?v=1" type="text/javascript"></script>
    ...
    <script src="Model/vipInfoVM.js" type="text/javascript"></script>
    <script src="Store/vipInfoStore.js" type="text/javascript"></script>
    <script src="View/SalesOrderCreateView.js" type="text/javascript"></script>
