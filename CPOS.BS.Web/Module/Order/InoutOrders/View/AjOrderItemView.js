...
function InitView() {
    ...
    Ext.create('jit.biz.SkuSelect', {
        ...
        fnCallback: function(d) {
            var stockNum = fnGetStockNum();
            var tbStockCtrl = Ext.getCmp("txtRequestNum");
            if (tbStockCtrl != null) {
                tbStockCtrl.setValue(fnGetStockNum(d.sku_id, 
                    sku_selected_data.unit_id, sku_selected_data.warehouse_id));
            }
        },
        skuPropId: {
