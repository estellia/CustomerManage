function InitView() {
    ...
    Ext.create('Ext.form.Panel', {
        ...
        {
            xtype: "jitdatefield",
            fieldLabel: "<font color='red'>*</font>出库日期",
            name: "complete_date",
            id: "txtCompleteDate",
            format: 'Y-m-d',
            isDefault: false,
...
Ext.create('Ext.grid.Panel', {
    store: Ext.getStore("purchaseInOrderEditItemStore"),
    id: "gridView",
    renderTo: "grid",
    columnLines: true,
    stripeRows: true,
...
//    width: "100%",
    ...
    columns: [
        ...
        { text: "出库数量", dataIndex: 'order_qty', width: 90, menuDisabled: true, align: "right", flex: 1 },
