...
function InitView() {
    ...
    Ext.create('Ext.form.Panel', {
        ...
        },
        {
            ...
            xtype: "jitbizmvordertype"
            , fieldLabel: "<font color='red'>*</font>调拨类型"
            , id: "txtOrderType"
            , name: "order_reason_id"
        },
        {
            xtype: "jitbizunitselecttree",
            fieldLabel: "<font color='red'>*</font>出库单位",
            name: "sales_unit_id",
            id: "txtSalesUnitId",
            isDefault: false,
            allowBlank: false
        ...
        },
        {
            ...
            , fieldLabel: "<font color='red'>*</font>出库仓库"
            ...
            xtype: "jitbizunitselecttree",
            fieldLabel: "<font color='red'>*</font>入库单位",
        ...
        {
            xtype: "jitbizwarehouse"
            , fieldLabel: "<font color='red'>*</font>入库仓库"
            , name: "purchase_warehouse_id"
            , id: "txtPurchaseWarehuouse"
            , parent_id: "txtPurchaseUnitId"
            , isDefault: false
            , allowBlank: false
        }, {
            xtype: "jittextfield",
...
//        { text: "调整数量", dataIndex: 'order_qty', width: 90, menuDisabled: true, align: "right", flex: 1 }
