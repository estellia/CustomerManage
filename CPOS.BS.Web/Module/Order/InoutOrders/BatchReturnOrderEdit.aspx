<%@ Page Title="批发退货单明细管理" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" 
AutoEventWireup="true" Inherits="JIT.CPOS.BS.Web.PageBase.JITPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    <title>批发退货单明细管理</title>
    ...
    <script src="Controller/BatchReturnOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/BatchReturnOrderEditView.js" type="text/javascript"></script>
