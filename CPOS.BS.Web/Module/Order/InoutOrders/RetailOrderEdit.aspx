<%@ Page Title="零售单明细" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/RetailOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/RetailOrderEditView.js" type="text/javascript"></script>
