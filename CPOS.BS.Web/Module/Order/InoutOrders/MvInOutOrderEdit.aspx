<%@ Page Title="调拨单明细管理" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="/Framework/javascript/biz/MvOrderType.js" type="text/javascript"></script>

    <script src="Controller/MvInOutOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/MvInOutOrderEditView.js" type="text/javascript"></script>
