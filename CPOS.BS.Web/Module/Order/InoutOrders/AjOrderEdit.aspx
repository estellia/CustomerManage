<%@ Page Title="调整单明细管理" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/AjOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/AjOrderEditView.js" type="text/javascript"></script>
