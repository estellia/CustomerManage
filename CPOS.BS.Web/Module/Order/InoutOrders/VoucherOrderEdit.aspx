<%@ Page Title="结算凭证明细" Language="C#" MasterPageFile="~/Framework/MasterPage/ChildPage.Master" AutoEventWireup="true" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/VoucherOrderEditCtl.js" type="text/javascript"></script>
    ...
    <script src="View/VoucherOrderEditView.js" type="text/javascript"></script>
