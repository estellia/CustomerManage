function InitView() {
    ...
    Ext.create('Ext.form.Panel', {
        ...
        {
            xtype: "jitdatefield",
            fieldLabel: "<font color='red'>*</font>完成日期",
            name: "complete_date",
            id: "txtCompleteDate",
            format: 'Y-m-d',
            isDefault: false,
        ...
        },
        {
            ...
            fieldLabel: "<font color='red'>*</font>盘点单位",
            name: "unit_id",
            id: "txtUnitId",
            isDefault: false,
            allowBlank: false
    ...
    Ext.create('Ext.grid.Panel', {
        store: Ext.getStore("ccOrderEditItemStore"),
        id: "gridView",
        renderTo: "grid",
        columnLines: true,
        stripeRows: true,
        ...
        },
        {
            ...
            renderer: function (value, p, record) {
                var str = "";
                var d = record.data;
                str += "<input type=\"text\" value=\"" + value + "\" class=\"text_ir\" " + " onchange=\"fnCalCelQty(this, '" + d.sku_id + "')\" />";
                return str;
            }
        },
        {
        ...
        },
        {
            ...
            renderer: function (value, p, record) {
                var str = "";
                var d = record.data;
                str += "<input type=\"text\" value=\"" + value + "\" class=\"text_i\" " + " onchange=\"fnChangeCellRemark(this, '" + d.sku_id + "')\" />";
                return str;
            }
        }]
    });
