...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/PurchaseOrderEditCtl.js" type="text/javascript"></script>
    <script src="Model/OrderVM.js" type="text/javascript"></script>
    <script src="Model/OrderDetailItemVM.js" type="text/javascript"></script>
    <script src="Store/PurchaseOrderEditVMStore.js" type="text/javascript"></script>
    <script src="View/PurchaseOrderEditView.js" type="text/javascript"></script>
</asp:Content>
