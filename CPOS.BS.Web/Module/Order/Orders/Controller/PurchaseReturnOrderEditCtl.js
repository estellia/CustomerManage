    ...
    if (order_id != "null" && order_id != "") {
        Ext.Ajax.request({
            ...
            success: function (response) {
                var storeId = "purchaseReturnOrderEditStore";
                ...
                Ext.getCmp("txtPurchaseUnitId").jitSetValue([{
                    "id": d.purchase_unit_id,
                    "text": d.purchase_unit_name
                }]);
...
function fnLoadItems() {
    var storeId = "purchaseReturnOrderEditItemStore";
...
function fnSave() {
    var _grid = Ext.getStore("purchaseReturnOrderEditItemStore");
    var order = {};
    ...
    Ext.Ajax.request({
        ...
        sync: true,
        async: false,
        url: 'Handler/OrderHandler.ashx?method=purchase_return_order_save&order_id=' + order_id,
        params: {
