...
function fnCreate() {
    var win = Ext.create('jit.biz.Window', {
        ...
        id: "SalesOrderEdit",
        title: "销售订单",
        url: "SalesOrderEdit.aspx?mid=" + __mid + "&op=new"
    });
...
function fnSearch() {
    Ext.getStore("salesOrderStore").proxy.url = JITPage.HandlerUrl.getValue() + "&method=sales_order";
    Ext.getStore("salesOrderStore").pageSize = JITPage.PageSize.getValue();
    Ext.getStore("salesOrderStore").proxy.extraParams = {
        form: Ext.JSON.encode(Ext.getCmp("searchPanel").getValues()),
        sales_unit_id: Ext.getCmp("txtSalesUnit").jitGetValue()
    };

    Ext.getStore("salesOrderStore").load();
}
...
function fnView(id) {
    ...
    var win = Ext.create('jit.biz.Window', {
        ...
        id: "SalesOrderEdit",
        title: "销售订单",
        url: "SalesOrderEdit.aspx?order_id=" + id
    });
