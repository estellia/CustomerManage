    ...
    if (order_id != "null" && order_id != "") {
        Ext.Ajax.request({
            ...
            success: function (response) {
                var storeId = "salesOrderEditStore";
...
function fnLoadItems() {
    var storeId = "salesOrderEditItemStore";
...
function fnSave() {
    var _grid = Ext.getStore("salesOrderEditItemStore");
    var order = {};
    ...
    Ext.Ajax.request({
        ...
        sync: true,
        async: false,
        url: 'Handler/OrderHandler.ashx?method=sales_order_save&order_id=' + order_id,
        params: {
