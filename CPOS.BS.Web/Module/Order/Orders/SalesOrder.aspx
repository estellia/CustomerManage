...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/SalesOrderCtl.js" type="text/javascript"></script>
    <script src="Model/SalesOrderVM.js" type="text/javascript"></script>
    <script src="Store/SalesOrderVMStore.js" type="text/javascript"></script>
    <script src="View/SalesOrderView.js" type="text/javascript"></script>
</asp:Content>
