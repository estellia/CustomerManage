...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/SalesReturnOrderCtl.js" type="text/javascript"></script>
    <script src="Model/SalesOrderVM.js" type="text/javascript"></script>
    <script src="Store/SalesReturnOrderVMStore.js" type="text/javascript"></script>
    <script src="View/SalesReturnOrderView.js" type="text/javascript"></script>
</asp:Content>
