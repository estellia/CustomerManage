...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/PurchaseReturnOrderEditCtl.js" type="text/javascript"></script>
    <script src="Model/OrderVM.js" type="text/javascript"></script>
    <script src="Model/OrderDetailItemVM.js" type="text/javascript"></script>
    <script src="Store/PurchaseReturnOrderEditVMStore.js" type="text/javascript"></script>
    <script src="View/PurchaseReturnOrderEditView.js" type="text/javascript"></script>
</asp:Content>
