...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/PurchaseOrderCtl.js" type="text/javascript"></script>
    <script src="Model/OrderVM.js" type="text/javascript"></script>
    <script src="Store/PurchaseOrderVMStore.js" type="text/javascript"></script>
    <script src="View/PurchaseOrderView.js" type="text/javascript"></script>
