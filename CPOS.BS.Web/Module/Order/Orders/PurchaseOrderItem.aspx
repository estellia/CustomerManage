...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    ...
    <script src="Controller/PurchaseOrderItemCtl.js" type="text/javascript"></script>
    <script src="Model/OrderVM.js" type="text/javascript"></script>
    <script src="Model/OrderDetailItemVM.js" type="text/javascript"></script>
    <script src="Store/PurchaseOrderItemVMStore.js" type="text/javascript"></script>
    <script src="View/PurchaseOrderItemView.js" type="text/javascript"></script>
            ...
            <div style="width:100%; padding:10px; padding-bottom:0px; 
                ...
                <div style="width:100%; padding-left:10px; padding-right:10px;">
                    <table class="z_main_tb">
                        ...
                        <tr class="z_main_tb_tr">
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>数量</td>
                            <td class="z_main_tb_td2" style="padding-top:0px; vertical-align:top; line-height:32px;">
                                <div id="txtEnterQty"></div>
                                <%--<input type="text" id="tbEnterQty" value="" class="text" maxlength="12" />--%>
                            </td>
                        ...
                        <tr class="z_main_tb_tr">
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>零售价（元）</td>
                            <td class="z_main_tb_td2" style="vertical-align:top; line-height:32px;">
                                <div id="txtRetailPrice"></div>
                                <%--<input type="text" id="tbRetailPrice" value="" class="text" maxlength="12" />
                                <span style="padding-left:2px; padding-right:2px;vertical-align:top; line-height:32px;">元</span>--%>
                            </td>
                        ...
                        <tr class="z_main_tb_tr">
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"><font color="red">*</font>采购价（元）</td>
                            <td class="z_main_tb_td2" style="vertical-align:top; line-height:32px;">
                                <div id="txtEnterPrice"></div>
                                <%--<input type="text" id="tbEnterPrice" value="" class="text" maxlength="12" />
                                <span style="padding-left:2px; padding-right:2px;vertical-align:top; line-height:32px;">元</span>--%>
                            </td>
                            <td class="z_main_tb_td" style="vertical-align:top; line-height:22px;"></td>
                            <td class="z_main_tb_td2" style="vertical-align:top; line-height:32px;">
                        ...
                        <%--<tr class="z_main_tb_tr">
                            <td colspan="4" style="width:100%; padding-left:10px; padding-top:10px;">
