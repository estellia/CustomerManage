    ...
    <script id="tpl_delivery" type="text/html">
        ...
        <#for(var i=0;i<list.length;i++){var item=list[i];#>
            <tr>
                ...
                <#var PropDetaiName="";if(entity.PropDetailName.split(";")[i]){PropDetaiName=entity.PropDetailName.split(";")[i]}#>
                <td><#=PropDetaiName#></td>
       ...
       <tr>
            ...
            <th colspan="5">
                ...
                <#}#>--%>
               <%-- 使用阿拉币
                <#if(entity.ALBAmount!=null){#>
                    <font>：<#=entity.ALB#>（<#=entity.ALBAmount#>元）</font>
                <#}#>
                、--%>
                <#if(entity.couponAmount){#>
                    优惠券:<font><#=entity.couponAmount#>元</font>
                <#}#>
                &nbsp;
                <#if(entity.payPointsAmount){#>
                    积分:<font><#=entity.payPoints#>（<#=entity.payPointsAmount#>元）</font>
                <#}#>
                &nbsp;
                <#if(entity.vipEndAmount){#>
                    余额抵扣:<font><#=entity.vipEndAmount#>元</font>
                <#}#>
                 &nbsp;
                <#if(entity.ReturnAmount){#>
                    返现抵扣:<font><#=entity.ReturnAmount#>元</font>
                <#}#>
               &nbsp;
                <#if(entity.VipDiscountAmount){#>
                    会员折扣:<font><#=entity.VipDiscountAmount.toFixed(2)#>元</font>
                <#}#>
            </th>
            <th>总抵扣</th>
                 <td></td>
            <#if(entity.AllDeduction){#>
            <td class="number"><#=entity.AllDeduction.toFixed(2)#></td>
            <#}else{#>'
