...
<div class="weChatMenuManage">
    ...
    <div class="leftArea" id="menuArea">
        ...
        <div class="tempEditArea">
            <div class="commonItem clearfix">
                ...
                <div class="handleWrap">
                    <input id="theKey" type="text" placeholder="多个关键字以(,)逗号分隔" class="inputBox" />
                </div>
            </div>
            ...
            <div class="commonItem clearfix">
                ...
                <div class="handleWrap">
                    <input id="keyNo" placeholder="输入正整数" type="text" class="inputBox" />
                </div>
            </div>
            ...
            <div class="commonItem clearfix">
                ...
                <div class="handleWrap">
                    <select id="category" class="selectBox">
                        <option selected value="2">回复消息</option>
                    </select>
                </div>
            </div>
...
<script type="text/javascript" src="/Module/static/js/lib/require.js" defer async="true" data-main="/Module/WeiXin/js/main"></script>
