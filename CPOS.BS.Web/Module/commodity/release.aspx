...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="allPage" id="section" data-js="js/release.js">
            <!-- 内容区域 -->
                   ...
                   <div class="panelDiv" id="nav01" data-index="0">
                        <div class="item"  >
                          <div class="commonSelectWrap">
                              ...
                              <div class="radio line14 " data-name="ifservice" data-value="0"><em></em><span>实物商品<br/>（物流发货）</span></div>
                              <div class="radio line14 on" data-name="ifservice" data-value="1" ><em></em><span>虚拟商品<br/> （无需物流）</span> </div>
                              </div>
                          </div>
                         </div>
                         ...
                         <div class="item" id="bulkBox">
                             <%--<div class="commonSelectWrap">
                                  <div class="selectBox" style="line-height:16px;">
                                      <div class="checkBox line14" data-name="isBulk" data-value="1"><em></em><span>支持预约线下</span></div>                           
                                  </div>
                             </div>
                             <div class="commonSelectWrap">
                                    <div class="selectBox" style="line-height:16px;">
                                        <div class="checkBox line14" data-name="isBulk" data-value="2"><em></em><span>支持到店</span></div>                           
                                    </div>
                             </div>
                             <div class="commonSelectWrap">
                                  <div class="selectBox" style="line-height:16px;">
                                      <div class="checkBox line14" data-name="isBulk" data-value="3"><em></em><span>支持送货上门</span></div>                           
                                  </div>
                             </div>--%>
                         </div>
                      
                      
                         <div class="item addItems" data-flag="ifservice">
                              <div class="xnType">
                                <div class="commonSelectWrap">
                                    <em class="tit">选择种类：</em>
                                    <label class="selectBox">
                                    <input data-text="选择种类" id="itemType" data-flag="Item_Name" class="itemType easyui-combobox" data-options="required:true,width:200,height:30" name="VirtualItemTypeId" type="text" value="">
                                    </label>
                                </div>
                                <div class="commonSelectWrap">
                                    <em class="tit">内容：</em>
                    ...
                    <div class="left">
                      ...
                      <div class="commonSelectWrap">
                          ...
                          <div class="classification"><span id="plRefresh">刷新</span><a href="Category.aspx" target="_blank">新建品类</a></div>
                      </div>
                      <div class="commonSelectWrap">
                          ...
                          <div class="classification"><span id="fzRefresh">刷新</span><a href="promotion.aspx?type=type=yd-sp" target="_blank">新建分组</a></div>
                      </div>
                    </div>
...
<!--郑先虎创建-->
<script id="tpl_AddVirtual" type="text/html" data-flag="备用不要删除">
 <div class="xnType">
 	<div class="commonSelectWrap" data-type="Clone">
 		...
 		<label class="selectBox">
 			<input data-text="选择种类" class="itemType easyui-combobox"
 			data-flag="Item_Name" data-options="required:true,width:200,height:30"
 			name="VirtualItemTypeId" type="text" value="">
 		</label>
 	</div>
 	<div class="commonSelectWrap">
 		<em class="tit">
 		...
 		<label class="selectBox">
 			<input data-text="商品名称"  data-flag="Item_Name" class="easyui-combobox"
 			data-options="required:true,width:200,height:30" name="ObjecetTypeId" type="text"
 			value="请选择">
 		</label>
 	</div>
 	<div class="commonSelectWrap">
 		...
 		<label class="selectBox">
 			<input data-text="商品名称" data-flag="Item_Math" class="easyui-validatebox"
 			data-options="required:true,width:200,height:30" name="mathTypeId" type="text"
 			value="1">
 			<em class="text">
 				张
 			</em>
