            ...
            that.getTableInfo(function(data){
                ...
                that.elems.tabel.datagrid({
                    ...
                    columns : [[
                        ...
                        {field : 'WithdrawNo',title : '提现单号',width:200,align:'left',resizable:false,
                        ...
                        {field : 'ApplyDate',title : '申请日期',width:80,align:'left',resizable:false
                            ,formatter:function(value ,row,index){
                        ...
                        {field : 'Amount',title : '提现金额',width:80,align:'left',resizable:false,
                            formatter:function(value,row,index){
                        ...
                        {field : 'CompleteDate',title : '完成日期',width:80,align:'left',resizable:false
                            ,formatter:function(value ,row,index){
                            if(value) {
                                return new Date(value).format("yyyy-MM-dd");
                            }
