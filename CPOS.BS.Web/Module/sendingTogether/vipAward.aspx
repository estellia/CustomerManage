...
<body cache>
<div class="allPage" id="section" data-js="js/vipAward.js?ver=0.1">
    <!-- 内容区域 -->
    ...
    <script type="text/html" id="tpl_setReward">
                            ...
                            <p  class="title">活动类型</p>
                                <div class="radio" data-cooperatetype="OneWay"  data-name="r1"   data-hide="twoway" data-show="oneway"><em></em> <span>互相集客(资源共享)</span></div>
                                 <div class="radio" data-cooperatetype="TwoWay"  data-name="r1" data-hide="oneway" data-show="twoway"><em></em> <span>单像集客(赚取佣金)</span></div>
                            </div>
                        <form id="addOneWay" >
