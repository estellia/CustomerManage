define(['jquery', 'template', 'tools', 'langzh_CN', 'easyui', 'kkpager', 'artDialog','noviceGuideJS'], function ($) {
    var page = {
        ...
        initEvent: function () {
                ...
                that.GetModuleNextStep({
                    ...
                    if (data.NowModule) {
                        var step1 = new noviceGuide("step1", {
                            ...
                            isShow: true,
                            title: "微信公众号授权",
                            content: "如果您还没有微信授权</br> 在此点击'绑定微信账号'",
                            ...
                            window.location.href = data.PreModule.Url;
                        }, function () {
            ...
            that.elems.tabelWrap.delegate(".SetWeChat", "click", function (e) {
                var id = $(this).data("id");
                that.loadData.SetWeChatTemplate(id);
            });
            /**************** -------------------弹出easyui 控件 start****************/
            var wd = 160, H = 32;
            ...
            that.elems.tabel.datagrid({
                ...
                columns: [[
...

                    {
                        ...
                        formatter: function (value, row, index) {
                            return "<div data-id=" + row.ApplicationId + " class='SetWeChat'></div>"
                            //<div title='解绑' data-index=" + index + " data-flag='unbundling' class='unbundling opt'></div>
                        }
                    }
   ...
   */
        ...
        loadData: {
            ...
            SetWeChatTemplate: function (ApplicationId, callback) {
                $.util.oldAjax({
                    url: "/Module/WApplication/Handler/WApplicationHandler.ashx",
                    data: {
                        action: 'SetWeChatTemplate',
