            ...
            that.elems.tabel.datagrid({
               ...
               /* frozenColumns:[[
                ...
                columns : [[
                    ...
                    { field: 'RefundNo', title: '退款单号', width: 150, align: 'left', resizable: false },
                    { field: 'OrderNo', title: '订单号', width: 150, align: 'left', resizable: false },
                ...
                onClickRow:function(rowindex,rowData){
                     ...
                     if(that.elems.click) {
                         ...
                         $.util.toNewUrlPath("refundDetail.aspx?RefundID=" + rowData.RefundID);
                     }
