    ...
    position: function (value) {
        ...
        if (elem && (elem.tagName == "TEXTAREA" || (elem.type && elem.type.toLowerCase() == "text"))) {
            ...
            var a, b, c = {
                ...
                d = this[0];
            return "fixed" === $.css(d, "position") ? b = d.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), $.nodeName(a[0], "html") || (c = a.offset()), c.top += $.css(a[0], "borderTopWidth", !0), c.left += $.css(a[0], "borderLeftWidth", !0)),
            {
                top: b.top - c.top - $.css(d, "marginTop", !0),
                left: b.left - c.left - $.css(d, "marginLeft", !0)
            }
        }
    }
