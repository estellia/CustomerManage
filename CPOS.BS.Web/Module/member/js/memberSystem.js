        ...
        initEvent: function () {
                ...
                that.GetModuleNextStep({
                    ...
                    "Step": stepIndex
                        ...
                        var Step = new noviceGuide("Step", {
                            ...
                            isShow: true,
                            title: "设置会员卡",
                            content: "设置会员卡基本信息及开卡礼，</br>领导会员成为忠诚会员。",
            ...
            that.elems.sectionPage.delegate(".uploadPanel.bgCover", "mouseenter", function () {
                ...
                .delegate(".checkBox", "click", function () {
                  ...
                  var filed=$(this).data("filed")
                    ...
                    var typeid = $(this).data("flag"),
						isFlag = (that.versionVal==3)?false:true;
					if(!isFlag && (typeid=='#nav02' || typeid=='#nav03')){
						$.util.dialogBox();
						return;
					}
                    //debugger;
                ...
                .delegate(".lump .addBtnPanel", "click", function () {
                    //debugger;
					var isFlag = (that.versionVal==3)?false:true,
						dom = $(this).parents(".lump"),
						type = dom.data("type");
                    if (type) {
						if(!isFlag && (type=='interests' || type=='card' || type=='level')){
							$.util.dialogBox();
							return;
						}
                        switch (type) {
