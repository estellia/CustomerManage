    ...
    var page = {
        ...
        initEvent: function () {
            ...
            that.elems.sectionPage.delegate(".queryBtn","click", function (e) {
                ...
                //查询数据
                that.loadData.getDayVendingCount(function(data){
                    //写死的数据
        ...
        loadPageData: function (e) {
           ...
           this.renderTable({Data:{DayVendingInfoList:null}},true)
        },
        ...
        renderTable: function (data,fistLoad) {
            ...
            if(!data.Data.DayVendingInfoList){

                data.Data.DayVendingInfoList=[];
                $(".count").hide();
            }else{
                $("#count").form("load",data.Data);
                $(".count").show();
            }
            ...
            that.elems.tabel.datagrid({
                ...
                //数据来源
                data:data.Data.DayVendingInfoList,
                ...
                columns : [[
                    ...
                    {field : 'MembershipTime',title : '售卡日期',width:100,align:'center',resizable:false},
                    {field : 'VipCardTypeName',title : '卡类型',width:90,resizable:false,align:'left'},
                    {field : 'SaleCardCount',title : '销售卡数量',width:66,align:'center',resizable:false},
                    {field : 'GiftCardCount',title : '赠送卡数量',width:65,align:'center',resizable:false},
                    {field : 'SalesAmount',title : '售卡金额（元）',width:68,align:'center',resizable:false}
          ...
          /*  if(data.Data.DayVendingInfoList.length>0) {
                //分页
        ...
        loadMoreData: function (currentPage) {
            ...
            $(".datagrid-body").html('<div class="loading"><span><img src="../static/images/loading.gif"></span></div>');
            that.loadData.getDayVendingCount(function(data){
                that.renderTable(data.Data.DayVendingInfoList);
            });
        },
        ...
        loadData: {
            ...
            opertionField:{},
            getDayVendingCount: function (callback) {
                var prams={data:{action:""}};
                prams.data={
                    action: "Report.StoresReport.GetDayVendingCount",
