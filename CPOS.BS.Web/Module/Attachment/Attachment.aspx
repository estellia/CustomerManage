...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="Controller/AttachmentCtl.js" type="text/javascript"></script>
    <script src="Model/AttachmentVM.js" type="text/javascript"></script>
    <script src="Store/AttachmentVMStore.js" type="text/javascript"></script>
    <script src="View/AttachmentView.js" type="text/javascript"></script>
</asp:Content>
