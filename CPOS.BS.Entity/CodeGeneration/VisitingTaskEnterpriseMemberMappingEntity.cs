...
namespace JIT.CPOS.BS.Entity
{
    ...
    /// 实体：  
    /// </summary>
    public partial class VisitingTaskEnterpriseMemberMappingEntity : BaseEntity ,IExtensionable
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VisitingTaskEnterpriseMemberMappingEntity()
        {
        }
        #endregion     
		...
		/// 
		/// </summary>
		public Guid? VisitingTaskEnterpriseMemberMappingID { get; set; }
        ...
        public  bool GetValueByPropertyName(string pPropertyName, out object pValue)
        {
            ...
            {
				case "VisitingTaskEnterpriseMemberMappingID":
					pValue = this.VisitingTaskEnterpriseMemberMappingID;
					result = true;
					break;
        ...
        public bool SetValueByPropertyName(string pPropertyName, object pValue)
        {
            ...
            switch (pPropertyName)
            {
				case "VisitingTaskEnterpriseMemberMappingID":
					{
						if (pValue != null)
							this.VisitingTaskEnterpriseMemberMappingID = (Guid)pValue;
						else
							this.VisitingTaskEnterpriseMemberMappingID = null;
						result = true;
					 }
					break;
				case "EnterpriseMemberID":
				...
				case "VisitingTaskID":
					{
						if (pValue != null)
							this.VisitingTaskID = (Guid)pValue;
						else
							this.VisitingTaskID = null;
						result = true;
					 }
					break;
				case "ClientID":
