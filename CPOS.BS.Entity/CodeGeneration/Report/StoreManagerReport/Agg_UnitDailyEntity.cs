...
namespace JIT.CPOS.BS.Entity
{
    ...
    /// 实体：  
    /// </summary>
    public partial class Agg_UnitDailyEntity : BaseEntity 
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_UnitDailyEntity()
        {
        }
        #endregion     
		...
		/// 
		/// </summary>
		public Decimal? SalesAmountPlan { get; set; }
		...
		/// 
		/// </summary>
		public Decimal? CompleteSalesAmount { get; set; }

		/// <summary>
		/// 
		/// </summary>
		public Decimal? NoCompleteSalesAmount { get; set; }
		...
		/// 
		/// </summary>
		public Decimal? DayTargetSalesAmount { get; set; }
