...
namespace JIT.CPOS.BS.Entity
{
    ...
    /// 实体：  
    /// </summary>
    public partial class ProductEntity : BaseEntity ,IExtensionable
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        ...
        public bool SetValueByPropertyName(string pPropertyName, object pValue)
        {
            ...
            switch (pPropertyName)
            {
				...
				case "ProductTitle":
					{
						if (pValue != null)
							this.ProductTitle = Convert.ToString(pValue);
						else
