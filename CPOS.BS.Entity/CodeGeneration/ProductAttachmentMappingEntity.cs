...
namespace JIT.CPOS.BS.Entity
{
    ...
    /// 实体：  
    /// </summary>
    public partial class ProductAttachmentMappingEntity : BaseEntity ,IExtensionable
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ProductAttachmentMappingEntity()
        {
        }
        #endregion     
		...
		/// 
		/// </summary>
		public Guid? ProductAttachmentMappingID { get; set; }
        ...
        public  bool GetValueByPropertyName(string pPropertyName, out object pValue)
        {
            ...
            {
				case "ProductAttachmentMappingID":
					pValue = this.ProductAttachmentMappingID;
					result = true;
					break;
				case "MediaType":
        ...
        public bool SetValueByPropertyName(string pPropertyName, object pValue)
        {
            ...
            switch (pPropertyName)
            {
				case "ProductAttachmentMappingID":
					{
						if (pValue != null)
							this.ProductAttachmentMappingID = (Guid)pValue;
						else
							this.ProductAttachmentMappingID = null;
						result = true;
					 }
					break;
				case "MediaType":
