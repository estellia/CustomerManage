...
namespace JIT.CPOS.BS.BLL
{
    ...
    public partial class BrowseHistoryBLL
    {
        ...
        /// 列表获取
        /// </summary>
        public IList<BrowseHistoryEntity> GetList(BrowseHistoryEntity entity, int Page, int PageSize)
        {
            ...
            IList<BrowseHistoryEntity> eventsList = new List<BrowseHistoryEntity>();
            DataSet ds = new DataSet();
            ds = _currentDAO.GetList(entity, Page, PageSize);
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                eventsList = DataTableToObject.ConvertToList<BrowseHistoryEntity>(ds.Tables[0]);
