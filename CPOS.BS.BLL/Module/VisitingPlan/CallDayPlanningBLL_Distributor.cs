...
namespace JIT.CPOS.BS.BLL
{
    ...
    /// CallDayPlanningBLL 
    /// </summary>
    public partial class CallDayPlanningBLL_Distributor : DistributorModuleCRUDBLL
    {
        ...
        public CallDayPlanningBLL_Distributor(LoggingSessionInfo pUserInfo, string pTableName)
        ...
        #region GetUserCDPDistributorList
        public PageResultEntity GetUserCDPDistributorList(List<DefindControlEntity> pSearch, int? pPageSize, int? pPageIndex, CallDayPlanningViewEntity_POP entity)
        {
            ...
            sql.AppendLine("main.DistributorID ,main.Coordinate into #outTemp");
            ...
            //new 这里不需要渠道查询条件
            sql.AppendLine(string.Format(" inner join (select distinct DistributorID from dbo.fnGetDistributorByUserID('{0}',1)) fn_sad on  CONVERT(nvarchar(100),main.DistributorID) = CONVERT(nvarchar(100),fn_sad.DistributorID) ", entity.ClientUserID));
            sql.AppendFormat(@" left join CallDayPlanning CPOPM 
                                on CPOPM.POPType=2 and cast(main.DistributorID as nvarchar(200))=CPOPM.POPID 
                                and CPOPM.isdelete=0 and CONVERT(date,CPOPM.CallDate,23)='{0}' and CPOPM.ClientUserID={1} 
                                and CPOPM.ClientID={2} ",
        ...
        #endregion
        #region EditUserCDPPOPList_Distributor
        /// <summary>
        /// 拜访计划终端选择
        /// </summary>
        ...
        public void EditUserCDPPOPList_Distributor(
        ...
        #endregion
        #region EditUserCDPPOPMap_Distributor
        /// <summary>
        /// 路线地图选择终端
        /// </summary>
        ...
        public void EditUserCDPPOPMap_Distributor(CallDayPlanningViewEntity_POP infoEntity, List<DefindControlEntity> pSearch, CallDayPlanningViewEntity_POP[] mappingEntity, string deletelist)
        {
            IDbTransaction tran = new TransactionHelper(this.CurrentUserInfo).CreateTransaction();
            using (tran.Connection)
            {
