...
namespace JIT.CPOS.BS.BLL.RedisOperationBLL.Order
{
    public class SuperRetailTraderOrderBLL
    {
											...
											if (amount > 0)
                                                  {
													...
													entityVipAmount = bllVipAmount.QueryByEntity(new VipAmountEntity() { VipId = dr["SuperRetailTraderID"].ToString(), IsDelete = 0 }, null).SingleOrDefault();
        ...
        public DataTable CreateTableProfitDetail()
        {
