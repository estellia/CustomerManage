...
{   
    ...
    public partial class TUserThirdPartyMappingBLL
    {
        ...
        private TUserThirdPartyMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TUserThirdPartyMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new TUserThirdPartyMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
