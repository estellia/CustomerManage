...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class AgentCustomerBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private AgentCustomerDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public AgentCustomerBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new AgentCustomerDAO(pUserInfo);
