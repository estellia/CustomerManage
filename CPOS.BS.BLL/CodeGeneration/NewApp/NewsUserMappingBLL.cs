...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class NewsUserMappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private NewsUserMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public NewsUserMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new NewsUserMappingDAO(pUserInfo);
