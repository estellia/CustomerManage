...
{   
    ...
    public partial class EclubMicroTypeBLL
    {
        ...
        private EclubMicroTypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public EclubMicroTypeBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new EclubMicroTypeDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
