...
{   
    ...
    public partial class EnterpriseMemberStructureBLL
    {
        ...
        private EnterpriseMemberStructureDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public EnterpriseMemberStructureBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new EnterpriseMemberStructureDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
