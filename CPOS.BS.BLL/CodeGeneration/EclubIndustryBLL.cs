...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class EclubIndustryBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private EclubIndustryDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public EclubIndustryBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new EclubIndustryDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
