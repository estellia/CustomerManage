...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class ReservationServicePositionMappingBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private ReservationServicePositionMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ReservationServicePositionMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new ReservationServicePositionMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
