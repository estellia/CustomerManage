...
{   
    ...
    public partial class VipCardGradeChangeLogBLL
    {
        ...
        private VipCardGradeChangeLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardGradeChangeLogBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VipCardGradeChangeLogDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
