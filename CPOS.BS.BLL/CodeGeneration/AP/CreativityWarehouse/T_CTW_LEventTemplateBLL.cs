...
{   
    ...
    public partial class T_CTW_LEventTemplateBLL
    {
        ...
        private T_CTW_LEventTemplateDAO _currentDAO;
        ...
        /// 构造函数 
        /// </summary>
        public T_CTW_LEventTemplateBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_CTW_LEventTemplateDAO(pUserInfo, connectionString);
