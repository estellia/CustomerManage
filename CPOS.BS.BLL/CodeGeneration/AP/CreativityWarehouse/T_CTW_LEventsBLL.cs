...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_CTW_LEventsBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_CTW_LEventsDAO _currentDAO;
        ...
        /// 构造函数 
        /// </summary>
        public T_CTW_LEventsBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_CTW_LEventsDAO(pUserInfo, connectionString);
