...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_ZMBA_CourseDetailBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_ZMBA_CourseDetailDAO _currentDAO;
        private string connectionString = ConfigurationManager.AppSettings["Conn_ap"];
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_ZMBA_CourseDetailBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_ZMBA_CourseDetailDAO(pUserInfo,connectionString);
