...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_UserGuideModulesBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_UserGuideModulesDAO _currentDAO;
		private string connectionString = ConfigurationManager.AppSettings["Conn_ap"];
		#region 构造函数
		/// <summary>
		/// 构造函数 
		/// </summary>
		public T_UserGuideModulesBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_UserGuideModulesDAO(pUserInfo, connectionString);
