...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_UnitNumApplyOrderBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_UnitNumApplyOrderDAO _currentDAO;
		private string connectionString = ConfigurationManager.AppSettings["Conn_ap"];
		#region 构造函数
		/// <summary>
		/// 构造函数 
		/// </summary>
		public T_UnitNumApplyOrderBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_UnitNumApplyOrderDAO(pUserInfo, connectionString);
