...
{   
    ...
    public partial class VipWithdrawDepositApplyBLL
    {
        ...
        private VipWithdrawDepositApplyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipWithdrawDepositApplyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipWithdrawDepositApplyDAO(pUserInfo);
