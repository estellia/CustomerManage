...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipWithdrawDepositBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipWithdrawDepositDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipWithdrawDepositBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipWithdrawDepositDAO(pUserInfo);
