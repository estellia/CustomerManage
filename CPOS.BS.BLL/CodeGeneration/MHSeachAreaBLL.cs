...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class MHSeachAreaBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private MHSeachAreaDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MHSeachAreaBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new MHSeachAreaDAO(pUserInfo);
