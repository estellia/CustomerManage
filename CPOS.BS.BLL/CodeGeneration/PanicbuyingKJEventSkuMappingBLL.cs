...
{   
    ...
    public partial class PanicbuyingKJEventSkuMappingBLL
    {
        ...
        private PanicbuyingKJEventSkuMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingKJEventSkuMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PanicbuyingKJEventSkuMappingDAO(pUserInfo);
