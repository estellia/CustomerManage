...
namespace JIT.CPOS.BS.BLL
{
    ...
    public partial class StoreItemDailyStatusBLL
    {
        ...
        private StoreItemDailyStatusDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public StoreItemDailyStatusBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new StoreItemDailyStatusDAO(pUserInfo);
