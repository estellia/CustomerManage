...
{   
    ...
    public partial class T_SuperRetailTraderItemMappingBLL
    {
        ...
        private T_SuperRetailTraderItemMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderItemMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderItemMappingDAO(pUserInfo);
