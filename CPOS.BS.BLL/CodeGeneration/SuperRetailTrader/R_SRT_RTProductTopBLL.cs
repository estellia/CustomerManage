...
{   
    ...
    public partial class R_SRT_RTProductTopBLL
    {
        ...
        private R_SRT_RTProductTopDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_SRT_RTProductTopBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_SRT_RTProductTopDAO(pUserInfo);
