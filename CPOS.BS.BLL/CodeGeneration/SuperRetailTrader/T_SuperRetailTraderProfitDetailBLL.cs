...
{   
    ...
    public partial class T_SuperRetailTraderProfitDetailBLL
    {
        ...
        private T_SuperRetailTraderProfitDetailDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderProfitDetailBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderProfitDetailDAO(pUserInfo);
