...
{   
    ...
    public partial class T_SuperRetailTraderSkuMappingBLL
    {
        ...
        private T_SuperRetailTraderSkuMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderSkuMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderSkuMappingDAO(pUserInfo);
