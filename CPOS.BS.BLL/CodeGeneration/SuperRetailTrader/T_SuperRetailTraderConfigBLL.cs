...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_SuperRetailTraderConfigBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_SuperRetailTraderConfigDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderConfigBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderConfigDAO(pUserInfo);
