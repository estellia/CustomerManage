...
{   
    ...
    public partial class T_SuperRetailTraderProfitConfigBLL
    {
        ...
        private T_SuperRetailTraderProfitConfigDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderProfitConfigBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderProfitConfigDAO(pUserInfo);
