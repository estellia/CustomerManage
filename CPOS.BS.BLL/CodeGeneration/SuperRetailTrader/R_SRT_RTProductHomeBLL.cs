...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_SRT_RTProductHomeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_SRT_RTProductHomeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_SRT_RTProductHomeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_SRT_RTProductHomeDAO(pUserInfo);
