...
{   
    ...
    public partial class T_SuperRetailTraderBLL
    {
        ...
        private T_SuperRetailTraderDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SuperRetailTraderBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SuperRetailTraderDAO(pUserInfo);
