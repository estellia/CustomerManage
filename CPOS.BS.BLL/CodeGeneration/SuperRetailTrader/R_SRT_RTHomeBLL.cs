...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_SRT_RTHomeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_SRT_RTHomeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_SRT_RTHomeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_SRT_RTHomeDAO(pUserInfo);
