...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class RetailTraderItemMappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private RetailTraderItemMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public RetailTraderItemMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new RetailTraderItemMappingDAO(pUserInfo);
