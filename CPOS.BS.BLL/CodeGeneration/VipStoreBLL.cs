...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipStoreBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipStoreDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipStoreBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipStoreDAO(pUserInfo);
