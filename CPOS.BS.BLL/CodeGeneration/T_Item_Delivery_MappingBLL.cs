...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Item_Delivery_MappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Item_Delivery_MappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Item_Delivery_MappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Item_Delivery_MappingDAO(pUserInfo);
