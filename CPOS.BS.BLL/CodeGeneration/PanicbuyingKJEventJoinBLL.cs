...
{   
    ...
    public partial class PanicbuyingKJEventJoinBLL
    {
        ...
        private PanicbuyingKJEventJoinDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingKJEventJoinBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PanicbuyingKJEventJoinDAO(pUserInfo);
