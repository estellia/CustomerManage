...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipDCodeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipDCodeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipDCodeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipDCodeDAO(pUserInfo);
