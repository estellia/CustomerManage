...
{   
    ...
    public partial class WXHouseReservationPayBLL
    {
        ...
        private WXHouseReservationPayDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXHouseReservationPayBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WXHouseReservationPayDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
