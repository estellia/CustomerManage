...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class TPaymentOrderLogBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private TPaymentOrderLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TPaymentOrderLogBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new TPaymentOrderLogDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
