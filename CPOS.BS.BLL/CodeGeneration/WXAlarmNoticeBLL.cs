...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WXAlarmNoticeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WXAlarmNoticeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXAlarmNoticeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WXAlarmNoticeDAO(pUserInfo);
