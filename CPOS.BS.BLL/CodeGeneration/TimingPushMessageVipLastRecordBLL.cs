...
{   
    ...
    /// 业务处理： 最后发送记录 
    /// </summary>
    public partial class TimingPushMessageVipLastRecordBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private TimingPushMessageVipLastRecordDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TimingPushMessageVipLastRecordBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new TimingPushMessageVipLastRecordDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
