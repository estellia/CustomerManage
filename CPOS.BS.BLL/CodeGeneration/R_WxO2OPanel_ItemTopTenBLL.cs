...
{   
    ...
    public partial class R_WxO2OPanel_ItemTopTenBLL
    {
        ...
        private R_WxO2OPanel_ItemTopTenDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_WxO2OPanel_ItemTopTenBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_WxO2OPanel_ItemTopTenDAO(pUserInfo);
