...
{   
    ...
    public partial class SysModulePageMappingBLL
    {
        ...
        private SysModulePageMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SysModulePageMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new SysModulePageMappingDAO(pUserInfo);
