...
{   
    ...
    public partial class R_WxO2OPanel_7DaysBLL
    {
        ...
        private R_WxO2OPanel_7DaysDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_WxO2OPanel_7DaysBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_WxO2OPanel_7DaysDAO(pUserInfo);
