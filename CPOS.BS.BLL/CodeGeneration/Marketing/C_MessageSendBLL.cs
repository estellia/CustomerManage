...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class C_MessageSendBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private C_MessageSendDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public C_MessageSendBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new C_MessageSendDAO(pUserInfo);
