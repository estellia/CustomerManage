...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class C_PrizesBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private C_PrizesDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public C_PrizesBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new C_PrizesDAO(pUserInfo);
