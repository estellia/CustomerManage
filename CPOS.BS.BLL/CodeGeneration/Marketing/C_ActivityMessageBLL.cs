...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class C_ActivityMessageBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private C_ActivityMessageDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public C_ActivityMessageBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new C_ActivityMessageDAO(pUserInfo);
