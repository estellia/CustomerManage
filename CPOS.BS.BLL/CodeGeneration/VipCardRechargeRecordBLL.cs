...
{   
    ...
    public partial class VipCardRechargeRecordBLL
    {
        ...
        private VipCardRechargeRecordDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipCardRechargeRecordBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VipCardRechargeRecordDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
