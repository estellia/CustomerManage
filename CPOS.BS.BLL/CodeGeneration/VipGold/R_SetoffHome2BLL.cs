...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_SetoffHome2BLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_SetoffHome2DAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_SetoffHome2BLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_SetoffHome2DAO(pUserInfo);
