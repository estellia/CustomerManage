...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class SetoffToolUserViewBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private SetoffToolUserViewDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SetoffToolUserViewBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new SetoffToolUserViewDAO(pUserInfo);
