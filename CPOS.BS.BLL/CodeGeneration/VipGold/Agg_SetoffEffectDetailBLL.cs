...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class Agg_SetoffEffectDetailBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private Agg_SetoffEffectDetailDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_SetoffEffectDetailBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new Agg_SetoffEffectDetailDAO(pUserInfo);
