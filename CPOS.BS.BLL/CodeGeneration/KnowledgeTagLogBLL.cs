...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class KnowledgeTagLogBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private KnowledgeTagLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public KnowledgeTagLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new KnowledgeTagLogDAO(pUserInfo);
