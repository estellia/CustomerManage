...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class KnowledgeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private KnowledgeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public KnowledgeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new KnowledgeDAO(pUserInfo);
