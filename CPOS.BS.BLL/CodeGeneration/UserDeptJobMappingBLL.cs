...
{   
    ...
    public partial class UserDeptJobMappingBLL
    {
        ...
        private UserDeptJobMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public UserDeptJobMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new UserDeptJobMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
