...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class APPVersionDownloadVIPLogBLL
    {
        ...
        /// 构造函数 
        /// </summary>
        public APPVersionDownloadVIPLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new APPVersionDownloadVIPLogDAO(pUserInfo,connectionString);
