...
{   
    ...
    public partial class T_UserGuideAccessLogBLL
    {
        ...
        private T_UserGuideAccessLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_UserGuideAccessLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_UserGuideAccessLogDAO(pUserInfo);
