...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WAttentionLogBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private WAttentionLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WAttentionLogBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WAttentionLogDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
