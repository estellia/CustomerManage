...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_WxO2OPanel_30DaysBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_WxO2OPanel_30DaysDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_WxO2OPanel_30DaysBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_WxO2OPanel_30DaysDAO(pUserInfo);
