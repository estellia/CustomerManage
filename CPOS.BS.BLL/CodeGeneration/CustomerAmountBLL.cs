...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class CustomerAmountBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private CustomerAmountDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerAmountBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerAmountDAO(pUserInfo);
