...
{   
    ...
    public partial class VwUnitPropertyBLL
    {
        ...
        private VwUnitPropertyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VwUnitPropertyBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VwUnitPropertyDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
