...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class Agg_UnitWeekly_VipCardTypeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private Agg_UnitWeekly_VipCardTypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_UnitWeekly_VipCardTypeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new Agg_UnitWeekly_VipCardTypeDAO(pUserInfo);
