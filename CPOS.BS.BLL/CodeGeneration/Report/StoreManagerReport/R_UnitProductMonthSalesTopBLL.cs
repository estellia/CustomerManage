...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_UnitProductMonthSalesTopBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_UnitProductMonthSalesTopDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_UnitProductMonthSalesTopBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_UnitProductMonthSalesTopDAO(pUserInfo);
