...
{   
    ...
    public partial class Agg_UnitMonthly_VipCardTypeBLL
    {
        ...
        private Agg_UnitMonthly_VipCardTypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_UnitMonthly_VipCardTypeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new Agg_UnitMonthly_VipCardTypeDAO(pUserInfo);
