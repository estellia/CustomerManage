...
{   
    ...
    public partial class Agg_Unit3MonthNoBackVipBLL
    {
        ...
        private Agg_Unit3MonthNoBackVipDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_Unit3MonthNoBackVipBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new Agg_Unit3MonthNoBackVipDAO(pUserInfo);
