...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class Agg_UnitYearly_EmplBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private Agg_UnitYearly_EmplDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public Agg_UnitYearly_EmplBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new Agg_UnitYearly_EmplDAO(pUserInfo);
