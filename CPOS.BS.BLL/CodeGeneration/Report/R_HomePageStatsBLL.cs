...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_HomePageStatsBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_HomePageStatsDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_HomePageStatsBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_HomePageStatsDAO(pUserInfo);
