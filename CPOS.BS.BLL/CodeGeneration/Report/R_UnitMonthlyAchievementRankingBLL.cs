...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class R_UnitMonthlyAchievementRankingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private R_UnitMonthlyAchievementRankingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public R_UnitMonthlyAchievementRankingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new R_UnitMonthlyAchievementRankingDAO(pUserInfo);
