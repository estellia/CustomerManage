...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WXRightOrdersBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WXRightOrdersDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXRightOrdersBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WXRightOrdersDAO(pUserInfo);
