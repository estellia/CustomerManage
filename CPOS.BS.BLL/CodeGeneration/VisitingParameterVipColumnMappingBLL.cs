...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VisitingParameterVipColumnMappingBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private VisitingParameterVipColumnMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VisitingParameterVipColumnMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VisitingParameterVipColumnMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
