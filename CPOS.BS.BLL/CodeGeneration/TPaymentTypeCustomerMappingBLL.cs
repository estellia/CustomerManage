...
{   
    ...
    public partial class TPaymentTypeCustomerMappingBLL
    {
        ...
        private TPaymentTypeCustomerMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TPaymentTypeCustomerMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new TPaymentTypeCustomerMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
