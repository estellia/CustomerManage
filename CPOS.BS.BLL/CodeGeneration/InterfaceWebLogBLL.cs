...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class InterfaceWebLogBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private InterfaceWebLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public InterfaceWebLogBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new InterfaceWebLogDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
