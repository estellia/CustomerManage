...
{   
    ...
    /// 业务处理： 定时推送规则 
    /// </summary>
    public partial class TimingPushMessageRuleBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private TimingPushMessageRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TimingPushMessageRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new TimingPushMessageRuleDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
