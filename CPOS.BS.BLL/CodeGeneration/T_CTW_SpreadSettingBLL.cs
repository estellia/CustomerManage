...
{   
    ...
    public partial class T_CTW_SpreadSettingBLL
    {
        ...
        private T_CTW_SpreadSettingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_CTW_SpreadSettingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_CTW_SpreadSettingDAO(pUserInfo);
