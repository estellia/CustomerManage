...
{   
    ...
    public partial class T_QN_QuestionnaireAnswerRecordBLL
    {
        ...
        private T_QN_QuestionnaireAnswerRecordDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_QuestionnaireAnswerRecordBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_QuestionnaireAnswerRecordDAO(pUserInfo);
