...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_QN_QuestionPicBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_QN_QuestionPicDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_QuestionPicBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_QuestionPicDAO(pUserInfo);
