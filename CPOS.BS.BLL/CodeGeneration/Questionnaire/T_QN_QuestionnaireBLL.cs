...
{   
    ...
    public partial class T_QN_QuestionnaireBLL
    {
        ...
        private T_QN_QuestionnaireDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_QuestionnaireBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_QuestionnaireDAO(pUserInfo);
