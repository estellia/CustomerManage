...
{   
    ...
    public partial class T_QN_ActivityQuestionnaireMappingBLL
    {
        ...
        private T_QN_ActivityQuestionnaireMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_ActivityQuestionnaireMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_ActivityQuestionnaireMappingDAO(pUserInfo);
