...
{   
    ...
    public partial class T_QN_QuestionnaireOptionCountBLL
    {
        ...
        private T_QN_QuestionnaireOptionCountDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_QuestionnaireOptionCountBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_QuestionnaireOptionCountDAO(pUserInfo);
