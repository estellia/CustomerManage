...
{   
    ...
    public partial class T_QN_ScoreRecoveryInformationBLL
    {
        ...
        private T_QN_ScoreRecoveryInformationDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_QN_ScoreRecoveryInformationBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_QN_ScoreRecoveryInformationDAO(pUserInfo);
