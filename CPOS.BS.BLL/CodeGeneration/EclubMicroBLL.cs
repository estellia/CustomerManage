...
{   
    ...
    public partial class EclubMicroBLL
    {
        ...
        private EclubMicroDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public EclubMicroBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new EclubMicroDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
