...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class GLServicePersonInfoBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private GLServicePersonInfoDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public GLServicePersonInfoBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new GLServicePersonInfoDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
