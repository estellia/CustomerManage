...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class PowerHourRemarkBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private PowerHourRemarkDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PowerHourRemarkBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new PowerHourRemarkDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
