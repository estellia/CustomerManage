...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_RewardRecordBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_RewardRecordDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_RewardRecordBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_RewardRecordDAO(pUserInfo);
