...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WXPayNoticeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WXPayNoticeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXPayNoticeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WXPayNoticeDAO(pUserInfo);
