...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class X_VipActivityApplyBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private X_VipActivityApplyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public X_VipActivityApplyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new X_VipActivityApplyDAO(pUserInfo);
