...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class X_VipPointMarkBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private X_VipPointMarkDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public X_VipPointMarkBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new X_VipPointMarkDAO(pUserInfo);
