...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class X_QuestionBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private X_QuestionDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public X_QuestionBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new X_QuestionDAO(pUserInfo);
