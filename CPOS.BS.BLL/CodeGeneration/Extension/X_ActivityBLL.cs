...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class X_ActivityBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private X_ActivityDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public X_ActivityBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new X_ActivityDAO(pUserInfo);
