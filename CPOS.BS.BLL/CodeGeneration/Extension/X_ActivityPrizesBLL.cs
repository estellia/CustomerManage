...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class X_ActivityPrizesBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private X_ActivityPrizesDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public X_ActivityPrizesBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new X_ActivityPrizesDAO(pUserInfo);
