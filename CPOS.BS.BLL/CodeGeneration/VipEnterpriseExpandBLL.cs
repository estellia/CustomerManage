...
{   
    ...
    public partial class VipEnterpriseExpandBLL
    {
        ...
        private VipEnterpriseExpandDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipEnterpriseExpandBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VipEnterpriseExpandDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
