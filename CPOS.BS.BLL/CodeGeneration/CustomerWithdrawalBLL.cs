...
{   
    ...
    public partial class CustomerWithdrawalBLL
    {
        ...
        private CustomerWithdrawalDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerWithdrawalBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerWithdrawalDAO(pUserInfo);
