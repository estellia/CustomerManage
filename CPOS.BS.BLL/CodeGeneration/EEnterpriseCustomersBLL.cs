...
{   
    ...
    public partial class EEnterpriseCustomersBLL
    {
        ...
        private EEnterpriseCustomersDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public EEnterpriseCustomersBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new EEnterpriseCustomersDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
