...
{   
    ...
    public partial class T_CTW_LEventInteractionBLL
    {
        ...
        private T_CTW_LEventInteractionDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_CTW_LEventInteractionBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_CTW_LEventInteractionDAO(pUserInfo);
