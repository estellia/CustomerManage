...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class SysTimeQuantumBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private SysTimeQuantumDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SysTimeQuantumBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new SysTimeQuantumDAO(pUserInfo);
