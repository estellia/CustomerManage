...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class ApplicationSupportLogBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private ApplicationSupportLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ApplicationSupportLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new ApplicationSupportLogDAO(pUserInfo);
