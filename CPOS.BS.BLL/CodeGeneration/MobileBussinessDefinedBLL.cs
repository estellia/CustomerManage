...
{   
    ...
    public partial class MobileBussinessDefinedBLL
    {
        ...
        private MobileBussinessDefinedDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MobileBussinessDefinedBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new MobileBussinessDefinedDAO(pUserInfo);
