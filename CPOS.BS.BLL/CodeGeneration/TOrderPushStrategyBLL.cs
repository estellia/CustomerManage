...
{   
    ...
    public partial class TOrderPushStrategyBLL
    {
        ...
        private TOrderPushStrategyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public TOrderPushStrategyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new TOrderPushStrategyDAO(pUserInfo);
