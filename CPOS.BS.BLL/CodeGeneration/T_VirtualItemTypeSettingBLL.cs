...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_VirtualItemTypeSettingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_VirtualItemTypeSettingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_VirtualItemTypeSettingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_VirtualItemTypeSettingDAO(pUserInfo);
        ...
        {
            return _currentDAO.BulkInsert(collection);
        }
    }
}