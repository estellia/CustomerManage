...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class LEventsSharePersonBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private LEventsSharePersonDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public LEventsSharePersonBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new LEventsSharePersonDAO(pUserInfo);
