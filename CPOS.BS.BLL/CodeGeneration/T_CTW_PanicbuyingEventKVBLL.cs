...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_CTW_PanicbuyingEventKVBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_CTW_PanicbuyingEventKVDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_CTW_PanicbuyingEventKVBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_CTW_PanicbuyingEventKVDAO(pUserInfo);
