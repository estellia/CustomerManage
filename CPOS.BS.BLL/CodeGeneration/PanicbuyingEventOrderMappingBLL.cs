...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class PanicbuyingEventOrderMappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private PanicbuyingEventOrderMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingEventOrderMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PanicbuyingEventOrderMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
