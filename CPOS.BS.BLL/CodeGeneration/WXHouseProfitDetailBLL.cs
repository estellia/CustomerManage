...
{   
    ...
    /// 业务处理： 收益历史记录表 
    /// </summary>
    public partial class WXHouseProfitDetailBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private WXHouseProfitDetailDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXHouseProfitDetailBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WXHouseProfitDetailDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
