...
{   
    ...
    public partial class GLDeviceInstallItemBLL
    {
        ...
        private GLDeviceInstallItemDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public GLDeviceInstallItemBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new GLDeviceInstallItemDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
