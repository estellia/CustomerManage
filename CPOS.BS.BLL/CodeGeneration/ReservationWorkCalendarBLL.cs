...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class ReservationWorkCalendarBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private ReservationWorkCalendarDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ReservationWorkCalendarBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new ReservationWorkCalendarDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
