...
{   
    ...
    public partial class WXHouseReservationRedeemBLL
    {
        ...
        private WXHouseReservationRedeemDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXHouseReservationRedeemBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WXHouseReservationRedeemDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
