...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class APPUpgradeBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private APPUpgradeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public APPUpgradeBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new APPUpgradeDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
