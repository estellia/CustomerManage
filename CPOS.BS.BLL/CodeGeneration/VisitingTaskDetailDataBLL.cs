...
{   
    ...
    /// 业务处理： 拜访明细数据 
    /// </summary>
    public partial class VisitingTaskDetailDataBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private VisitingTaskDetailDataDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VisitingTaskDetailDataBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VisitingTaskDetailDataDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
