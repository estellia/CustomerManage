...
{   
    ...
    public partial class VisitingParameterOptionsBLL
    {
        ...
        private VisitingParameterOptionsDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VisitingParameterOptionsBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VisitingParameterOptionsDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
