...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WMenuMTextMappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WMenuMTextMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WMenuMTextMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WMenuMTextMappingDAO(pUserInfo);
