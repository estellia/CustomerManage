...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VwMarketEventAnalysisBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private VwMarketEventAnalysisDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VwMarketEventAnalysisBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new VwMarketEventAnalysisDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
