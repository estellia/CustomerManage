...
{   
    ...
    public partial class PanicbuyingKJEventJoinDetailBLL
    {
        ...
        private PanicbuyingKJEventJoinDetailDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingKJEventJoinDetailBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PanicbuyingKJEventJoinDetailDAO(pUserInfo);
