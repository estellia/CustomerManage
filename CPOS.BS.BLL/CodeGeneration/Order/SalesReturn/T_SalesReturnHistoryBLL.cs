...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_SalesReturnHistoryBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_SalesReturnHistoryDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_SalesReturnHistoryBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_SalesReturnHistoryDAO(pUserInfo);
