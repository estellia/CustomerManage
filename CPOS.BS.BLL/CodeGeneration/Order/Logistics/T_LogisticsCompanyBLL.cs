...
{   
    ...
    public partial class T_LogisticsCompanyBLL
    {
        ...
        private T_LogisticsCompanyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_LogisticsCompanyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_LogisticsCompanyDAO(pUserInfo);
