...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class CustomerModuleMappingBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private CustomerModuleMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerModuleMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerModuleMappingDAO(pUserInfo);
