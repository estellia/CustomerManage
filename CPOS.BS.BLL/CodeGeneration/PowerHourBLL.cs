...
{   
    ...
    public partial class PowerHourBLL
    {
        ...
        private PowerHourDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PowerHourBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new PowerHourDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
