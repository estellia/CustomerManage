...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class LEventAddupBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private LEventAddupDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public LEventAddupBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new LEventAddupDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
