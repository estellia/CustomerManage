...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class CustomerPlotBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private CustomerPlotDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerPlotBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerPlotDAO(pUserInfo);
