...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class CustomerDeliveryStrategyBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private CustomerDeliveryStrategyDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerDeliveryStrategyBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerDeliveryStrategyDAO(pUserInfo);
