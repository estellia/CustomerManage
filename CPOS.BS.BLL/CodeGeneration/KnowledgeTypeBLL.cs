...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class KnowledgeTypeBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private KnowledgeTypeDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public KnowledgeTypeBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new KnowledgeTypeDAO(pUserInfo);
