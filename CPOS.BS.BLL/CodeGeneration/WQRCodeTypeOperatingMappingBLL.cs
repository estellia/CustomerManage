...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WQRCodeTypeOperatingMappingBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private WQRCodeTypeOperatingMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WQRCodeTypeOperatingMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new WQRCodeTypeOperatingMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
