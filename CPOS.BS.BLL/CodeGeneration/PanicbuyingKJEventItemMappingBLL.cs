...
{   
    ...
    public partial class PanicbuyingKJEventItemMappingBLL
    {
        ...
        private PanicbuyingKJEventItemMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingKJEventItemMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new PanicbuyingKJEventItemMappingDAO(pUserInfo);
