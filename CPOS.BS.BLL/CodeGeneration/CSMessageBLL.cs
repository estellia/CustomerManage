...
{   
    ...
    /// 业务处理： 客服消息 
    /// </summary>
    public partial class CSMessageBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private CSMessageDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CSMessageBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new CSMessageDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
