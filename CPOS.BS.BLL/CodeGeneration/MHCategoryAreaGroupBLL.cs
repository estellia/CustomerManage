...
{   
    ...
    public partial class MHCategoryAreaGroupBLL
    {
        ...
        private MHCategoryAreaGroupDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MHCategoryAreaGroupBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new MHCategoryAreaGroupDAO(pUserInfo);
