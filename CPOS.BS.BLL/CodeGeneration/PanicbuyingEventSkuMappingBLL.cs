...
{   
    ...
    public partial class PanicbuyingEventSkuMappingBLL
    {
        ...
        private PanicbuyingEventSkuMappingDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PanicbuyingEventSkuMappingBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new PanicbuyingEventSkuMappingDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
