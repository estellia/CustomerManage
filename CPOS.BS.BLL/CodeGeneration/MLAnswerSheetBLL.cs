...
{   
    ...
    /// 业务处理： 答卷表 
    /// </summary>
    public partial class MLAnswerSheetBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private MLAnswerSheetDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MLAnswerSheetBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new MLAnswerSheetDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
