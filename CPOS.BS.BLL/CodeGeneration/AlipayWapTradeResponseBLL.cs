...
{   
    ...
    public partial class AlipayWapTradeResponseBLL
    {
        ...
        private AlipayWapTradeResponseDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public AlipayWapTradeResponseBLL(BasicUserInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new AlipayWapTradeResponseDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
