...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class VipServicesLogBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private VipServicesLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public VipServicesLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new VipServicesLogDAO(pUserInfo);
