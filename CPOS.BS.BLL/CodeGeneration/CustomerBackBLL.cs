...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class CustomerBackBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private CustomerBackDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public CustomerBackBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new CustomerBackDAO(pUserInfo);
