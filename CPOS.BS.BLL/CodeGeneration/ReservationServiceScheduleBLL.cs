...
{   
    ...
    public partial class ReservationServiceScheduleBLL
    {
        ...
        private ReservationServiceScheduleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ReservationServiceScheduleBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new ReservationServiceScheduleDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
