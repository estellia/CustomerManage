...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WXSalesPushLogBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WXSalesPushLogDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXSalesPushLogBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WXSalesPushLogDAO(pUserInfo);
