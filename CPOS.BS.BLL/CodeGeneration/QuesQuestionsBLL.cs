...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class QuesQuestionsBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private QuesQuestionsDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public QuesQuestionsBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new QuesQuestionsDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
