...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class T_Role_Menu_FunctionBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private T_Role_Menu_FunctionDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public T_Role_Menu_FunctionBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new T_Role_Menu_FunctionDAO(pUserInfo);
