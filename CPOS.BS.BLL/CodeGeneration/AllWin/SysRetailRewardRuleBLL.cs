...
{   
    ...
    public partial class SysRetailRewardRuleBLL
    {
        ...
        private SysRetailRewardRuleDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SysRetailRewardRuleBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new SysRetailRewardRuleDAO(pUserInfo);
