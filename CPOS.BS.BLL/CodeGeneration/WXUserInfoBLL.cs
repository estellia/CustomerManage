...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class WXUserInfoBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private WXUserInfoDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public WXUserInfoBLL(LoggingSessionInfo pUserInfo)
        {
            this._currentDAO = new WXUserInfoDAO(pUserInfo);
