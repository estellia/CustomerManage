...
{   
    ...
    /// 业务处理：  
    /// </summary>
    public partial class ReservationServicePositionStatusBLL
    {
        private LoggingSessionInfo CurrentUserInfo;
        private ReservationServicePositionStatusDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public ReservationServicePositionStatusBLL(LoggingSessionInfo pUserInfo)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new ReservationServicePositionStatusDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
