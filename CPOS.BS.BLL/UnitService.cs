    ...
    public class UnitService : BaseService
    {
        ...
        public string SetUnitInfo(LoggingSessionInfo loggingSessionInfo, UnitInfo unitInfo, bool IsTran = true)
        {
            ...
            try
            {
                ...
                {
                    Operation = iType == 1 ? OptEnum.Create : OptEnum.Update,
        ...
        public DataSet ExcelToDb(DataTable dtExcel, LoggingSessionInfo CurrentUserInfo)
        {
        ...
        public int GetUnitCountByCustomerId(string strCustomerId) {
			return this.unitService.GetUnitCountByCustomerId(strCustomerId);
		}
